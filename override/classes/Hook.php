...
class Hook extends HookCore
{
    ...
    */
    public static function getHookModuleExecList($hook_name = null)
    {
        ...
        if (!Cache::isStored($cache_id) || $hook_name == 'displayPayment' || $hook_name == 'displayPaymentEU' || $hook_name == 'paymentOptions' || $hook_name == 'displayBackOfficeHeader') {
            ...
            if ($result = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS($sql)) {
                foreach ($result as $row) {
                     ...
                     * To remove the display override template hoOk from the execution list
            ...
            if ($hook_name != 'displayPayment' && $hook_name != 'displayPaymentEU' && $hook_name != 'paymentOptions' && $hook_name != 'displayBackOfficeHeader') {
                ...
                /**
                 * Commented as there is no use of below as it @deprecated in 1.5.0
                 * @date 13-02-2023
        ...
        if ($hook_name) {
            /**
            * To handle compatibility changes for PrestaShop 8 : Replacing the deprecated "getRetroHookName" function with "normalizeHookName" in versions 8.0.0 and above. Otherwise, it uses the "getRetroHookName" function.
            * @date 13-02-2023
            * @author Tanisha Gupta
            */
            if (_PS_VERSION_ >= '8.0.0') {
                $retro_hook_name = Tools::strtolower(Hook::normalizeHookName($hook_name));
            } else {
