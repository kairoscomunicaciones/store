...
$(document).ready(function(){
   ...
   $(document).on('click','.input-color',function(e) {
    ...
    if ( $('.tabhome_title_list li:first-child .nav-link.active').length > 0 ){
        return false;
    } else {
        var first_active = $('.tabhome_title_list li:first-child .nav-link').attr('href');
        $('.tabhome_title_list li:first-child .nav-link').addClass('active');
    ...
    $(document).on('click','.product_showmore > span',function(){
       $(this).parent().toggleClass('active').parent().find('.product_miniature_hidden').toggleClass('active');
    });
