                ...
                <ul class="breadcrumb_page_other">
                    <li>
                        <a href="{$urls.base_url|escape:'html':'UTF-8'}">
                          <span itemprop="name">{l s='Home' d='Shop.Theme.Actions'}</span>
                        </a>
                    </li>
                    <li>
                        <span>/</span>
                    ...
                    <li>
                        <span itemprop="name">{l s='Sales' d='Shop.Theme.Actions'}</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="breadcrumb_wrapper">
            <div class="container">
                <ul class="breadcrumb_page_other">
                    ...
                    <li>
                        <span itemprop="name">{l s='Search' d='Shop.Theme.Actions'}</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="breadcrumb_wrapper">
            <div class="container">
                <ul class="breadcrumb_page_other">
                    ...
                    <li>
                        <span itemprop="name">{l s='Sitemap' d='Shop.Theme.Actions'}</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="breadcrumb_wrapper">
            <div class="container">
                <ul class="breadcrumb_page_other">
                    ...
                    <li>
                        <span itemprop="name">{l s='Best Sellers' d='Shop.Theme.Actions'}</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="breadcrumb_wrapper">
            <div class="container">
                <ul class="breadcrumb_page_other">
                    ...
                    <li>
                        <span itemprop="name">{l s='Stores' d='Shop.Theme.Actions'}</span>
                    </li>
                </ul>
            </div>
        </div>
