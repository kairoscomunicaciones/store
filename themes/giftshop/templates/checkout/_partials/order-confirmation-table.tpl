  ...
  <div class="order-confirmation-table">
      ...
      {foreach from=$products item=product}
        <div class="order-line row">
          ...
          <div class="col-sm-6 col-xs-12 qty">
            <div class="row">
              <div class="col-xs-5 text-sm-right text-xs-left">{$product.price|escape:'html':'UTF-8'}
              ...
              <div class="col-xs-5 text-xs-right bold">{$product.total|escape:'html':'UTF-8'}
    ...
    <table>
      {foreach $subtotals as $subtotal}
        {if $subtotal.type !== 'tax'}
          <tr>
            ...
            <td>{$subtotal.value|escape:'html':'UTF-8'}
      ...
      <tr class="font-weight-bold">
        ...
        <td>{$totals.total.value|escape:'html':'UTF-8'}
