                                ...
                                {if $allowComments}
                                    <div class="ybc_comment_form_blog">
                                        ...
                                        <div class="ybc-blog-form-comment">                   
                                            ...
                                            {if isset($comment_not_login) && $comment_not_login}
                                        ...
                                        {foreach from=$blog_post.related_posts item='rpost'}                                            
                                            <li class="ybc-blog-related-posts-list-li thumbnail-container">
                                                ...
                                                <div class="ybc-blog-sidear-post-meta">
                                                    ...
                                                    {/if}
                                                    <span class="post-date">{l s='Posted on' d='Shop.Theme.Actions'}<span> {date($date_format,strtotime($rpost.datetime_added))|escape:'html':'UTF-8'}</span></span>
                                                </div>
