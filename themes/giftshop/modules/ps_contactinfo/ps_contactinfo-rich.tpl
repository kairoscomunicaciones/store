...
<div class="contact-rich">
  {if isset($tc_config.BLOCKCONTACTINFOS_ADDRESS) && $tc_config.BLOCKCONTACTINFOS_ADDRESS}
            <div class="block">
                ...
                <div class="data"><span class="data_title">{l s='Address:' d='Shop.Theme.Actions'}</span><br />
  ...
  {if isset($tc_config.BLOCKCONTACTINFOS_PHONE_LABEL) && $tc_config.BLOCKCONTACTINFOS_PHONE_LABEL}
    <div class="block">
      ...
      <div class="data"><span class="data_title">{l s='Call us:' d='Shop.Theme.Actions'}</span><br/>
  ...
  {if $contact_infos.fax}
    <div class="block">
      ...
      <div class="data"><span class="data_title">{l s='Fax:' d='Shop.Theme.Actions'}</span><br/>
  ...
  {if $contact_infos.email}
    <div class="block">
      ...
      <div class="data email"><span class="data_title">{l s='Email us:' d='Shop.Theme.Actions'}</span><br/>
