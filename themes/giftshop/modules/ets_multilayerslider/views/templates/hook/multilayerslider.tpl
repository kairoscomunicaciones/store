...
<div class="ets_multilayerslider{if isset($tc_config.YBC_TC_ENABLE_CATE_BLOCK) && $tc_config.YBC_TC_ENABLE_CATE_BLOCK == 0} multislider_full{/if}{if $mls_configs.ETS_MLS_SLIDER_TYPE=='full'}hidden{/if}">
