...
{if $widgets}
            ...
            <div class="home_widget_top_column">
                <ul class="ybc-widget-{$widget_hook|escape:'html':'UTF-8'} row">
                    {foreach from=$widgets item='widget'}
                        <li class="ybc-widget-item{if isset($widget.custom_class) && $widget.custom_class} {$widget.custom_class|escape:'html':'UTF-8'}{/if}">
                            <div class="ybc-widget-item-content">
                                ...
                                {if isset($widget.subtitle) && $widget.subtitle}
                                    <h4 class="ybc-widget-subtitle">{$widget.subtitle|escape:'html':'UTF-8'}</h4>
                                {/if}
                ...
                <li class="ybc-widget-item">
                    <div class="ybc-widget-item-content {if $widget.custom_class} {$widget.custom_class|escape:'html':'UTF-8'}{/if}">
                        ...
                        <div class="ybc-widget-description-content">
                            ...
                            {/if}
                            {if $widget.link}<a class="button_widget" href="{$widget.link|escape:'html':'UTF-8'}">{l s='Shop now ' d='Shop.Theme.Active'} <i class="fa fa-angle-double-right"></i></a>{/if}
                        </div>
                    </div>
                </li>
    ...
    {else if $widget_hook == "display-home"}
        <div class="ybc-widget-{$widget_hook|escape:'html':'UTF-8'} col-xs-12 col-sm-12{if isset($tc_config.YBC_TC_ENABLE_BANNER) && $tc_config.YBC_TC_ENABLE_BANNER} show_banner_on_mobile{/if}">
                ...
                {foreach from=$widgets item='widget'}
                        <div class="ybc-widget-item-content">
                            ...
                            <p class="widget_sub_title">
                                {$widget.subtitle|escape:'html':'UTF-8'}
                            </p>
                            <div class="ybc-widget-description-content">
                                {if $widget.show_title && $widget.title}<h4 class="ybc-widget-title">{if $widget.link}
                                <a href="{$widget.link|escape:'html':'UTF-8'}">{/if}{$widget.title|escape:'html':'UTF-8'}{if $widget.link}</a>{/if}</h4>{/if}
