...
class Ybc_themeconfig extends Module
{
    ...
    public function __construct()
	{
       ...
       $this->configs = array(
            ...
            'YBC_TC_ENABLE_STORE' => array(
                'label' => $this->l('Enable "STORE LOCATOR"'),
                'type' => 'switch',
                'default' => 1,
                'group' => 'ybc_tab_header',
            ),
            'YBC_TC_ENABLE_STORE_LINK' => array(
                'label' => $this->l('"STORE LOCATOR" Link'),
                'type' => 'text',
                'default' => 'https://www.google.co.in/maps/place/PrestaShop/@25.767568,-80.1989669,17z/data=!3m1!4b1!4m5!3m4!1s0x88d9b6823bb65e3b:0xf45950e4a4f33bbd!8m2!3d25.767568!4d-80.1967782',
                'group' => 'ybc_tab_header',
            ),
				...
				'options' => array(
        			 'query' => array(                             
                            array(
                                ...
                                'slides' => array(1,2,3),
                                'widget' => array(14,53,54,72,73,74,75,76),
                                'menus' => array(1,2,3,4,7,5,6),
                            ),
            ...
            'YBC_TC_COPYRIGHT_TEXT' => array(                
                ...
                'type' => 'textarea',
                'group' => 'ybc_tab_footer',                
                'default' => 'Copyright 2017 <a href="#">Gift Shop Co., LTD.</a>  All rights reserved',
            ), 
            ...
            'YBC_TC_FONT3_DATA' => array(                
                ...
                'group' => 'ybc_tab_font',    
                'data_type' => 'font',  
                'default' => 'https://fonts.googleapis.com/css?family=Prociono',
                'validate' => 'isString',                 
            ),  
    ...
    public function renderConfig()
    {
     ...
     private function _postConfig()
     {
        ...
        {
            $this->clearCache();
            die(Tools::jsonEncode(array('success' => $this->l('Cache is cleared'))));
        }    
    ...
    public function renderCss()
    {
        ...
        {
            $css .= '.product-price-and-shipping{font-family: '.$font3.';}';
        }
