...
//        $this->module_key = '68a34cdd0bc05f6305874ea844eefa05';
        ...
        $this->displayName = $this->l('SuperCheckout Free Version');
    ...
    {
        if (file_exists(dirname(__FILE__) . '/libraries/kb_tracker/tracking.php')) {
            include_once dirname(__FILE__) . '/libraries/kb_tracker/tracking.php';
            captureAndSendAdminDetails();
        }
...
//            die();
            ...
            foreach ($carriers as $deliverymethod) {
                ...
                if (isset($_FILES['velocity_supercheckout_payment'])) {
                    $method_file = $_FILES['velocity_supercheckout_payment'];
                    if (!isset($method_file['size']['delivery_method'][$id]['logo']['name']) || $method_file['size']['delivery_method'][$id]['logo']['name'] == 0) {
        ...
        $this->supercheckout_settings['payment_method']['display_style'] = 0;
        $this->supercheckout_settings['payment_method']['default'] = '';
        $this->supercheckout_settings['shipping_method']['display_style'] = 0;
        $this->supercheckout_settings['shipping_method']['default'] = '';
//        print_r($this->supercheckout_settings);
//        die;
...
//            Configuration::updateValue('VELOCITY_SUPERCHECKOUT_BUTTON', serialize($custombutton));
//        } else {
...
//        }
        ...
        if (Configuration::get('VELOCITY_SUPERCHECKOUT_BUTTON')
            ...
            $data = unserialize(Configuration::get('VELOCITY_SUPERCHECKOUT'));
    ...
    {
//        Configuration::updateGlobalValue('VELOCITY_SUPERCHECKOUT_DEMO', 1);
    ...
    public function downloadFile($field_id)
    {
        ...
        $file = Tools::unSerialize($data['field_value']);
