    ...
    <div class="myaccount rectangle-list text-center">
        <ul class="accountOptions">
            ...
            <li  class="accountLogoutLi">
                <a href="{$sc_logout_url}"><i class="fas fa-sign-out-alt"></i> {l s='Logout' mod='supercheckout'}</a>
            </li>
        </ul>
...
{else}
    ...
    {/if}
    <div id="supercheckout-option" class="form-group login-options text-center">
    ...
    <div id="social_login_block" style="display: none;">
        ...
        {if $settings['fb_login']['enable'] neq 1 && $settings['google_login']['enable'] neq 1}
            ...
            <div class="social-login">
                ...
                <div class="sigInButtons">

                {if $settings['fb_login']['enable'] eq 1}
                    {if $settings['social_login_popup']['enable'] eq 1}
                        <a onclick="return !window.open(this.href, 'popup', 'width=450,height=300,left=500,top=500')" target="_blank" href="{$supercheckout_url|escape:'quotes'}&myfbLogin" class="fbButton btn azm-social azm-btn azm-pill azm-facebook" id="fb-auth" ><i class="fa fa-facebook"></i>  Facebook</a>
                        {*escape not required as contains url*}
                        
                    {else}
                        <a href="{$supercheckout_url|escape:'quotes'}&myfbLogin" class="fbButton btn azm-social azm-btn azm-pill azm-facebook" id="fb-auth" ><i class="fa fa-facebook"></i> Facebook</a> 
                        {*escape not required as contains url*}
                    {/if}
                {/if}
                {if $settings['google_login']['enable'] eq 1}
                    {if $settings['social_login_popup']['enable'] eq 1}
                        <a onclick="return !window.open(this.href, 'popup', 'width=500,height=500,left=500,top=500')" target="_blank" href="{$supercheckout_url|escape:'quotes'}&myGoogleLogin" class="googleButton btn azm-social azm-btn azm-pill azm-google-plus" ><i class="fab fa-google"></i> Google</a>
                        {*escape not required as contains url*}
                    {else}
                        <a href="{$supercheckout_url|escape:'quotes'}&myGoogleLogin" class="googleButton btn azm-social azm-btn azm-pill azm-google-plus" ><i class="fab fa-google"></i> Google</a>
                        {*escape not required as contains url*}
                    {/if}
                {/if}
                </div>
