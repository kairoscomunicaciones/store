...
class PsCheckoutManager extends PaymentManager
{
    ...
    public function isValidPaymentMethod($cart = null)
    {
        ...
        return version_compare($moduleInstance->version, '6.3.0', '>=') && parent::isValidPaymentMethod($cart) && (is_null($cart) || $cart->nbProducts() > 0);
    }
