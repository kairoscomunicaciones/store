...
class AppSaveProductReview extends AppCore
{
    ...
    public function getPageData()
    {
        ...
        if (!$error) {
            ...
            if (!Validate::isLoadedObject($this->product)) {
                ...
                $this->content['response'] = $this->saveProductComments();
            }
        }
    ...
    public function saveProductComments()
    {
        ...
        if (!count($errors)) {
            ...
            if (count(Tools::getValue('rating')) >= 1) {
                    $comment->grade = $grade_sum / count(Tools::getValue('rating'));
