 ...
 * Description
 *
 * API for  reordering an order
 */

require_once 'AppCore.php';

class AppReorder extends AppCore
{
    /**
     * This function is trigger whenever this class is called in API and
     * make duplicate cart of provided session_data
        ...
        if (!(int) Tools::getValue('session_data', 0)) {
            ...
            if (Tools::getIsset('order_id')) {
                ...
                $this->content['status'] = 'failure';
                    $this->content['message'] = parent::getTranslatedTextByFileAndISO(
                        Tools::getValue('iso_code', false),
                        $this->l('Sorry. We cannot renew your order. Order Id is missing'),
                        'AppReorder'
                    );
