 ...
 * Description
 *
 * API to remove gift wrapping from the cart
 */

require_once 'AppCore.php';

class AppRemoveGiftWrapping extends AppCore
{
    /**
    ...
    public function getCartData()
    {
        if (!Validate::isLoadedObject($this->context->cart)) {
            ...
            $this->content['message'] = '';
            $this->writeLog('Gift Wrapping removed from the cart');
            $this->context->cart->update();
