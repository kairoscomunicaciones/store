 ...
 * Description
 *
 * API to update address details of customer
 */

require_once 'AppCore.php';

class AppUpdateAddress extends AppCore
{
     ...
     *
     */
    public function processSubmitKbAddress()
    {
        $address_data = Tools::getValue('shipping_address', json_encode(array()));
...
//            }
            ...
            if ($this->validateKbPostAddress($address)) {
                ...
                if ($address->save()) {
                    ...
                    if ($id_address != 0) {
                        $this->content['shipping_address_response'] = array(
                            'status' => 'success',
                    ...
                    $this->content['id_shipping_address'] = (String) $address->id;
                } else {
                    $this->content['shipping_address_response'] = array(
                        'status' => 'failure',
                        'message' => parent::getTranslatedTextByFileAndISO(
     ...
     *
     * @param Object Address $address address object
     * @return bool
     */
