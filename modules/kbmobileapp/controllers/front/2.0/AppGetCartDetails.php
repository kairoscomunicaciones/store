...
class AppGetCartDetails extends AppCore
{
        ...
        if (!(int) Tools::getValue('session_data', 0)) {
            ...
            if (Tools::getIsset('order_id')) {
                ...
                */
                ...
                $oldCart = new Cart((int) Tools::getValue('session_data', 0), $lang_id);
    ...
    public function getCartData()
    {
        if (!Validate::isLoadedObject($this->context->cart)) {
            ...
            foreach ($cart_summary['products'] as $product) {
                ...
                // Date:- 03-Jun-2022
                // Fixes:- CHanges made to implement the Stock Management Off.
                ...
                */
                ...
                if (!isset($cart_products[$index]['customizable_items'])) {
                    ...
                    //die(print_r($temp_customized_data));
    ...
    {
        /**
         * Show option on cart page in the selected langauge
