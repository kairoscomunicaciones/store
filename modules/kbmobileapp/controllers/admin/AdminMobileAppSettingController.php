...
class AdminMobileAppSettingController extends ModuleAdminControllerCore
{
    public function __construct()
    {
        parent::__construct();

        $this->toolbar_title = $this->module->l('Knowband Mobile App', 'AdminMobileAppSettingController');
    }
