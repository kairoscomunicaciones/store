...
{else if isset($vss_cjc_link)  && $vss_cjc_link eq 'vss_delete_custom_banner_old'}
    
    <button class='edit btn btn-default' title='delete' onclick='delete_custom_banner(this);' >
           <i class='icon-trash' style='padding-right:5px'></i>{l s='Delete' mod='kbmobileapp'}
    </button>
    
{else if isset($vss_cjc_link)  && $vss_cjc_link eq 'vss_delete_custom_banner_new'}
    
    <a class='edit btn btn-default' title='delete' onclick='delete_custom_banner(this);' >
           <i class='icon-trash' style='padding-right:5px'></i>{l s='Delete' mod='kbmobileapp'}
    </a>
...
{else if isset($vss_cjc_link)  && $vss_cjc_link eq 'vss_edit_custom_banner_old'}
    <button class='edit btn btn-default' title='Edit' onclick='edit_custom_banner(this);'>
        <i class='icon-pencil'></i>{l s='Edit' mod='kbmobileapp'}
    </button>
{else if isset($vss_cjc_link)  && $vss_cjc_link eq 'vss_edit_custom_banner_new'}
    <a class='edit btn btn-default' title='Edit' onclick='edit_custom_banner(this);'>
        <i class='icon-pencil'></i>{l s='Edit' mod='kbmobileapp'}
    </a>    
{else if isset($vss_cjc_link)  && $vss_cjc_link eq 'vss_edit_banner_old'}
    <button class='edit btn btn-default' title='Edit' onclick='edit_banner(this);'>
        <i class='icon-pencil'></i>{l s='Edit' mod='kbmobileapp'}
    </button>
{else if isset($vss_cjc_link)  && $vss_cjc_link eq 'vss_edit_banner_new'}
    <a class='edit btn btn-default' title='Edit' onclick='edit_banner(this);'>
        <i class='icon-pencil'></i>{l s='Edit' mod='kbmobileapp'}
    </a>
{/if}
