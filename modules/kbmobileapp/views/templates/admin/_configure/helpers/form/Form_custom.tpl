...
<script>
    var layout_select = "{l s='Please enter the Layout name in all Language' mod='kbmobileapp'}";
     var delete_layout_default = "{l s='Default Layout Cannot be deleted' mod='kbmobileapp'}";
     var min_category_layout_message = "{l s='Please Select 4 Categories or Layout' mod='kbmobileapp'}";
     var fill_details_message = "{l s='Please fill all details' mod='kbmobileapp'}";
    /*start:changes made by aayushi on 3rd January 2020 to add custom banners*/
    var width_error = "{l s='Enter the width' mod='kbmobileapp'}";
    var can_not_edit = "{l s='You are not allowed to edit the elements for this store.' mod='kbmobileapp'}";
    var height_error = "{l s='Enter the height' mod='kbmobileapp'}";
    var total_shops = "{$total_shops|escape:'quotes':'UTF-8'}";
    var custom_banner_delete_message = "{l s='Banner Deleted successfully.' mod='kbmobileapp' }";
    /*start:changes made by aayushi on 3rd January 2020 to add custom banners*/
    /* start:changes started by Aayushi Agarwal on 30 August 18 to add gdpr tab*/
    var gdpr_settings = "{l s='GDPR Settings' mod='kbmobileapp'}";
    ...
    var select_redirect_txt = "{l s='Please select Redirect Activity' mod='kbmobileapp' }";
   
     var select_layout_txt = "{l s='Please select layout' mod='kbmobileapp' }";
    ...
    var preview_img_dir = "{$preview_img_dir}";
    var display_logo_on_title_bar = "{$display_logo_on_title_bar}";
    var title_bar_logo_url = "{$title_bar_logo_url}";
    {*start: changes made by Vibhaas Saxena *}
    var default_layout = "{$default_layout}";
    {*end: Changes end *}
    var home_pic_url =  "{$home_pic_url}";
    var top_bar_color = "{$top_bar_color}";
    var Select_the_Countdown_Validity_Text = "{l s='Select the Countdown Validity' mod='kbmobileapp' }";
    var live_app_gif = "{$live_app_gif}";
    var chat_icon = "{$chat_icon}";
    var show_preview = "{l s='Show Preview' mod='kbmobileapp' }";
    var hide_preview = "{l s='Hide Preview' mod='kbmobileapp' }";
    var chat_error_text = "{l s='Only one chat option can be enabled at a time' mod='kbmobileapp' }";
...
{if $version eq 1.6}
        <div class="row" id="kbmobileapp_configuration_form">
            ...
            <div class="vss-add-new" style="display:none">
                ...
                {$add_new_layout_button}{*Variable contains html content, escape not required*}
                <div id="layout_list">
                ...
                {*end: changes made by Aayushi Agarwal on 15 April 2019  to add tab bar functionality*}
                {* start:changes started by Aayushi Agarwal on 30 August 18 to add gdpr tab*}
                {$gdpr_settings_form}{*Variable contains html content, escape not required*}
                
                {$load_gdpr_page}{*Variable contains html content, escape not required*}
                {* end:changes started by Aayushi Agarwal on 30 August 18 to add gdpr tab*}
        </div>
        {else}
            <div class="row" id="kbmobileapp_configuration_form">
