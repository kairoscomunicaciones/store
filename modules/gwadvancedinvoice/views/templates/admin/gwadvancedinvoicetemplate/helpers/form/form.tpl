...
{block name="field"}
    {if $input.type == 'tab-invoice-template'}
        <ul class="tabs-create">
            <li class="active"><a href="javascript:void(0);" data-id="setting">{l s='General setting' mod='gwadvancedinvoice'}</a></li>
            <li><a href="javascript:void(0);" data-id="template">{l s='Template' mod='gwadvancedinvoice'}</a></li>
            <li><a href="javascript:void(0);" data-id="barcode">{l s='Barcode and Watermark' mod='gwadvancedinvoice'}</a></li>
            <li><a href="javascript:void(0);" data-id="cusstomcss">{l s='CSS Custom' mod='gwadvancedinvoice'}</a></li>
        </ul>
    {elseif $input.type == 'urlimg'}
        {literal}
        <script type="text/javascript">
            $.fn.mColorPicker.defaults.imageFolder = {/literal}"{$input.urlimg|escape:'htmlall':'UTF-8'}"{literal};
        </script>
        {/literal}
    {elseif $input.type == 'tabopen'}
        </div>
        <div id="{if isset($input.id) && $input.id != ''}{$input.id|escape:'html':'UTF-8'}{/if}" class="formbuilder_tab{if isset($input.id) && $input.id == 'setting'} active{/if} {$input.class|escape:'htmlall':'UTF-8'}">
        <div>
    {elseif $input.type == 'tabclose'}
        </div>

    {elseif $input.type == 'sidebar'}
        <div class="col-lg-3">
            <ul class="nav nav-tabs list-group">
                <li class="list-group-item active"><a data-toggle="tab" href="#A4">A4</a></li>
                <li class="list-group-item"><a data-toggle="tab" href="#A5">A5</a></li>
                <li class="list-group-item"><a data-toggle="tab" href="#A6">A6</a></li>
                <li class="list-group-item"><a data-toggle="tab" href="#A7">A7</a></li>
                <li class="list-group-item"><a data-toggle="tab" href="#usletter">usletter</a></li>
            </ul>
        </div>
        <div class="col-lg-9">
            <div class="list-size">
                <div class="tab-content">
                    {foreach from=$input.options.query item=template key=key}
                        <div id="{$key|escape:'htmlall':'UTF-8'}" class="tab-pane fade in {if isset($key) && $key == 'A4'}active{/if}" pagesize_id="{$key|escape:'htmlall':'UTF-8'}">
                            <input type="radio" name="pagesize" value="{$key|escape:'htmlall':'UTF-8'}" class="hide">
                            {foreach from=$template item=items}
                                {$items nofilter} {* $item is html content, no need to escape*}
                            {/foreach}
                        </div>
                        </div>
                    {/foreach}
    ...
    {elseif $input.type == 'choose_design'}
        <div class="col-lg-3">
        ...
        <div class="col-lg-9">
        <div>
    {elseif $input.type == 'watermark_lang'}
        <div class="col-lg-9 border_water">
    		<div class="row">
    ...
    {elseif $input.type == 'margin_layout'}
        <div class="col-lg-9">
            <div class="row">
                <div class="col-lg-4">
    ...
    {elseif $input.type == 'textarea_fullwidth'}
        <div class="{if isset($input.parent) && $input.parent}{$input.parent|escape:'htmlall':'UTF-8'}{/if}">
            <div class="col-lg-9">
                {foreach from=$languages item=language}
        				{if $languages|count > 1}
        					<div class="translatable-field lang-{$language.id_lang|escape:'htmlall':'UTF-8'}" {if $language.id_lang != $defaultFormLanguage}style="display:none"{/if}>
    ...
    {elseif $input.type == 'template_config'}
        <button type="button" class="customtemplate_style btn btn-default"><i class="icon-cog"></i></button>
        <div class="panel panel-default template_style">
            <div class="panel-heading">{l s='Customize template style' mod='gwadvancedinvoice'}</div>
            <div class="panel-body">
                <div class="col-lg-12">
                    <div class="row">
                        {if isset($fields_value['template_config']) && $fields_value['template_config']}
