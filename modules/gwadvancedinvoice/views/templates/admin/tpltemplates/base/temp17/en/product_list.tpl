...
<table class="product" width="100%" cellpadding="7" cellspacing="0">
    <thead>
    	<tr>
            {foreach $titles as $key=>$value}
                <th class="product header small {if $align[$key] !=''} align{$align[$key]|escape:'html':'UTF-8'} {else} alignleft {/if}" width="{$widthtitles[$key]|escape:'html':'UTF-8'}%"><strong class="strong_item">{$titles[$key]|escape:'html':'UTF-8'}</strong></th>
            {/foreach}
        </tr>
    </thead>
	<tbody>
