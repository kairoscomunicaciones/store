...
*/
*}
<table id="wrap" style="width: 100%; float: left;" cellpadding="0" cellspacing="0"><tr><td>
    <table style="margin-bottom: 20px; width: 100%; float: left;" class="border_bottom">
        ...
        <table cellpadding="10" cellspacing="0"  style="width: 100%; float: left;" class="background_color">
        <tr>
            <td style="width: 33%;"><h4 class="invoice_title">INVOICE</h4></td>
            <td style="width: 34%;">
        ...
        <table cellpadding="10" cellspacing="0"  style="width: 100%; float: left;" class="">
        <tr>
            <td style="width: 33%;">
    ...
    <table style="width: 100%; float: left;">
        <tbody>
            ...
            <tr>
                <td colspan="2">
                    <h4 class="header_title">TERMS & CONDITIONS</h4>
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0"  >
        <tr>
            ...
            <td  style="width:70%;">{$products_list|escape:'htmlall':'UTF-8'}</td>
        </tr>
    </table>
    <table style="width: 100%;" cellpadding="0" cellspacing="0">
        <tbody>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestri haec verecundius, illi fortasse constantius. Quae diligentissime contra Aristonem dicuntur a Chryippo. Satis est ad hoc responsum. Aliter enim explicari, quod quaeritur, non potest.</p>
                                </td>
                            </tr>
    ...
    <table style="width: 100%;">
        <tbody>
            <tr><td><h4 class="thanksfor">Thank for your bussiness !</h4></td></tr>
        </tbody>
    </table>
</td></tr></table>