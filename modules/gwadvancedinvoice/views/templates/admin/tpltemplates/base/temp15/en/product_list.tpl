...
<table class="product" width="100%" cellpadding="5" cellspacing="0">
    	...
    	<tr class="bg-last">
            {foreach $titles as $key=>$value}
                        ...
                        <td  class="product header small {if $align[$key] !=''} align{$align[$key]|escape:'html':'UTF-8'} {else} alignleft {/if}" width="{$widthtitles[$key]-1|escape:'html':'UTF-8'}%">{$titles[$key]|escape:'html':'UTF-8'}</td>
                        <td  style="background:#fff; width: 1%;"></td>
