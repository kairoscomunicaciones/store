<table class="product" width="100%" cellpadding="5" cellspacing="0">
    <thead>
    	<tr>
                            <th class="product header small    alignleft " width="16%">Referencia</th>
                            <th class="product header small    aligncenter " width="16%">Product</th>
                            <th class="product header small    aligncenter " width="16%">Cant.</th>
                            <th class="product header small    aligncenter " width="16%">Presentacion</th>
                            <th class="product header small    aligncenter " width="16%">Volumen</th>
                            <th class="product header small  total_title_background    alignleft " width="20%">Peso</th>
                    </tr>
    </thead>
	<tbody>
	...
	{foreach $order_details as $order_detail}
		...
		<tr class="product {$bgcolor_class}">
			               ...
			               <td class="product   alignleft "  width="16%">{$order_detail.product_reference}</td>
                           <td class="product   aligncenter "  width="16%"><p class="product_name">{$order_detail.product_name}</p>{$order_detail.description_short}</td>
                           <td class="product   aligncenter "  width="16%">{$order_detail.product_quantity}</td>
                           <td class="product   aligncenter "  width="16%">{$order_detail.feature6}</td>
                           <td class="product   aligncenter "  width="16%">{$order_detail.feature7}</td>
                           <td class="product  totalitembackground   alignleft "  width="20%">{$order_detail.product_weight}</td>
            		</tr>
