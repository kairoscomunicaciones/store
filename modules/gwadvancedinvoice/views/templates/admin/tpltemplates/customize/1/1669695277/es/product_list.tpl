<table class="product" width="100%" cellpadding="5" cellspacing="0">
    <thead>
    	<tr>
                            <th class="product header small  alignleft " width="29%">Product</th>
                            <th class="product header small  aligncenter " width="23%">Unit Price (Tax Excl.)</th>
                            <th class="product header small  aligncenter " width="23%">Qty</th>
	...
	{foreach $order_details as $order_detail}
		...
		<tr class="product {$bgcolor_class}">
			               ...
			               <td class="product  alignleft "  width="29%"><p class="product_name">{$order_detail.product_name}</p>{$order_detail.description_short}</td>
                           <td class="product  aligncenter "  width="23%">{displayPrice currency=$order->id_currency price=$order_detail.unit_price_tax_excl_including_ecotax}</td>
                           <td class="product  aligncenter "  width="23%">{$order_detail.product_quantity}</td>
                           <td class="product  aligncenter "  width="25%">{displayPrice currency=$order->id_currency price=$order_detail.total_price_tax_excl_including_ecotax}</td>
            		</tr>
