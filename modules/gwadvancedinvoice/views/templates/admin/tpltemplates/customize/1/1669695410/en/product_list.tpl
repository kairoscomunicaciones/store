<table class="product" width="100%" cellpadding="5" cellspacing="0">
    <thead>
    	<tr>
                            <th class="product header small    alignleft " width="16%">Product</th>
                            <th class="product header small    aligncenter " width="16%">Qty</th>
                            <th class="product header small    aligncenter " width="16%">Total Price</th>
                            <th class="product header small    alignleft " width="16%">Product</th>
                            <th class="product header small    alignleft " width="16%">Product</th>
                            <th class="product header small  total_title_background    alignleft " width="20%">Product</th>
                    </tr>
    </thead>
	<tbody>
	...
	{foreach $order_details as $order_detail}
		...
		<tr class="product {$bgcolor_class}">
			               ...
			               <td class="product   alignleft "  width="16%"><p class="product_name">{$order_detail.product_name}</p>{$order_detail.description_short}</td>
                           <td class="product   aligncenter "  width="16%">{$order_detail.product_quantity}</td>
                           <td class="product   aligncenter "  width="16%">{displayPrice currency=$order->id_currency price=$order_detail.total_price_tax_excl_including_ecotax}</td>
                           <td class="product   alignleft "  width="16%"><p class="product_name">{$order_detail.product_name}</p>{$order_detail.description_short}</td>
                           <td class="product   alignleft "  width="16%"><p class="product_name">{$order_detail.product_name}</p>{$order_detail.description_short}</td>
                           <td class="product  totalitembackground   alignleft "  width="20%"><p class="product_name">{$order_detail.product_name}</p>{$order_detail.description_short}</td>
            		</tr>
