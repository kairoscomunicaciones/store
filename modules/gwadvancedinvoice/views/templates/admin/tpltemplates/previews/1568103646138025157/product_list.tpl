...
<table class="product" width="100%" cellpadding="5" cellspacing="0">
    <thead>
    	<tr>
                            ...
                            <th class="product header small  aligncenter " width="%"></th>
                            <th class="product header small  alignleft " width="%">Product</th>
                            <th class="product header small  aligncenter " width="%">Unit Price (Tax Excl.)</th>
                            <th class="product header small  aligncenter " width="%">Qty</th>
                            <th class="product header small  aligncenter " width="%">Total (Tax Excl.)</th>
                    </tr>
    </thead>
	<tbody>
	...
	{foreach $order_details as $order_detail}
		...
		<tr class="product {$bgcolor_class}">
                           ...
                           <td class="product  aligncenter "  width="%">{$order_detail.image_tag}</td>
