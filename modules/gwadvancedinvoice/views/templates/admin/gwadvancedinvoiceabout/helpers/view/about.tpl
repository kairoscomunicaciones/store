    		...
    		<div id="left_intro" class="col-lg-12 col-md-12">
    			...
    			<table class="table">
                    ...
                    <tbody>
                        ...
                        <tr><td>{l s='{$nbr_product}' mod='gwadvancedinvoice'}</td><td>{l s='Total product quantity' mod='gwadvancedinvoice'}</td></tr>
                        <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                        ...
                        <tr><td>{l s='{$delivery_date_add}' mod='gwadvancedinvoice'}</td><td>{l s='Delivery date add' mod='gwadvancedinvoice'}</td></tr>
                        <tr><td>{l s='{$delivery_date_upd}' mod='gwadvancedinvoice'}</td><td>{l s='Delivery date update' mod='gwadvancedinvoice'}</td></tr>
                        <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                        ...
                        *}
                        ...
                        <tr><td>{l s='{$order_detail.date_add}' mod='gwadvancedinvoice'}</td><td>{l s='Time add product' mod='gwadvancedinvoice'}</td></tr>
                        <tr><td>{l s='{$order_detail.date_upd}' mod='gwadvancedinvoice'}</td><td>{l s='Time update product' mod='gwadvancedinvoice'}</td></tr>
