...
{foreach from= $fields item='field'}
    ...
    <div class="row form-group{if isset($field.form_group_class)} {$field.form_group_class|escape:'html':'UTF-8'}{/if}">
        ...
        <div class="col-lg-12{if $field.type=='date'} datepicker {/if}{if isset($field.condition_fields) && $field.condition_fields} massedit-form-field {$field.name|escape:'html':'UTF-8'}{/if}" {if isset($field.condition_fields_selected) && $field.condition_fields_selected=='off'} style="display:none"{/if}>
