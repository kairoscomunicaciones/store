                                    ...
                                    {foreach from =$attributeGroup.attributes item='attribute'}
                                        <div class="attribute">
                                            <div class="ets_input_group">
                                                <input  name="attribute_options[{$attribute.id_attribute_group|intval}][{$attribute.id_attribute|intval}]" id="attribute-{$attribute.id_attribute|intval}" class="js-attribute-checkbox massedit-field" data-label="{$attributeGroup.name|escape:'html':'UTF-8'} : {$attribute.name|escape:'html':'UTF-8'}" data-value="{$attribute.id_attribute|intval}" data-group-id="{$attribute.id_attribute_group|intval}" type="checkbox" value="{$attribute.id_attribute|intval}" />
