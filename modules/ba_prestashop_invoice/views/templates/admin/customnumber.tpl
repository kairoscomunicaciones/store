	...
	<div class="col-sm-12 form-group" style="margin-bottom: 10px;display: none;">
		...
		<div class="col-sm-5">
			{foreach from=$groupcus item=igroupcus}
				{assign var="id_group" value=$igroupcus['id_group']}
				<div class="row" style="margin-top: 10px;">
					...
					{foreach from=$languages item=lang}
						...
						{assign var="language" value=$lang['name']}
						<div class="row group-access-languages">
							<div class="col-sm-5 text-right">{$language|escape:'htmlall':'UTF-8'}</div>
							<div class="col-sm-5">
								<select name="baidtempinvoice[{$igroupcus['id_group']|escape:'htmlall':'UTF-8'}][{$id_lang|escape:'htmlall':'UTF-8'}]" class="form-control">
									{foreach from=$bagetinvoice item=isqlgetinvoice}
										{if $isqlgetinvoice['id_lang'] == $id_lang}
										{assign var="id_invoice" value=$isqlgetinvoice['id']}
										<option {if $id_invoice == $tabinvoicecus1[$id_group][$id_lang]['id_template_invoice']}selected{/if} value="{$id_invoice|escape:'htmlall':'UTF-8'}">
										{$isqlgetinvoice['name']|escape:'htmlall':'UTF-8'} ({$languages_name[$isqlgetinvoice['id_lang']]|escape:'htmlall':'UTF-8'})
										</option>
										{/if}
									{/foreach}
								</select>
				...
				<div class="row" style="margin-top: 10px;">
					...
					{foreach from=$languages item=lang}
						...
						<div class="row group-access-languages">
							<div class="col-sm-5 text-right">{$language|escape:'htmlall':'UTF-8'}</div>
							<div class="col-sm-5">
								<select name="baidtempdeli[{$igroupcus['id_group']|escape:'htmlall':'UTF-8'}][{$id_lang|escape:'htmlall':'UTF-8'}]" class="form-control">
									{foreach from=$bagetdeli item=ibagetdeli}
										{if $ibagetdeli['id_lang'] == $id_lang}
										{assign var="id_delivery" value=$ibagetdeli['id']}
										<option {if $id_delivery == $tabdelicus1[$id_group][$id_lang]['id_template_delivery']}selected{/if} value="{$id_delivery|escape:'htmlall':'UTF-8'}">
										{$ibagetdeli['name']|escape:'htmlall':'UTF-8'} ({$languages_name[$ibagetdeli['id_lang']]|escape:'htmlall':'UTF-8'})
										</option>
										{/if}
									{/foreach}
								</select>
				...
				<div class="row" style="margin-top: 10px;">
					...
					<div class="col-sm-9">
						...
						<div class="row group-access-languages">
							<div class="col-sm-5 text-right">{$language|escape:'htmlall':'UTF-8'}</div>
							<div class="col-sm-5">
								<select name="baidtempcre[{$id_group|escape:'htmlall':'UTF-8'}][{$id_lang|escape:'htmlall':'UTF-8'}]" class="form-control">
									{foreach from=$bagetcre item=ibagetcre}
										{if $ibagetcre['id_lang'] == $id_lang}
										{assign var="id_credit" value=$ibagetcre['id']}
										<option {if $id_credit == $tabcrecus1[$id_group][$id_lang]['id_template_credit']}selected{/if} value="{$id_credit|escape:'htmlall':'UTF-8'}">
										{$ibagetcre['name']|escape:'htmlall':'UTF-8'} ({$languages_name[$ibagetcre['id_lang']]|escape:'htmlall':'UTF-8'})
										</option>
										{/if}
									{/foreach}
								</select>
	...
	<div style="display: none;" class='form-group col-sm-12'>
		...
		<div class='col-sm-3'>
			<div class="form-element">
				...
				<p class="description">{l s='Shortcode: [counter] [m] [Y] [y] [d] - month, year, 2 digits of year, day from date of invoice' mod='ba_prestashop_invoice'}</p>
			</div>
		</div>
	</div>
	<div style="display: none;" class='form-group col-sm-12'>
		...
		<div class='col-sm-9'>
			...
			<div class="form-group col-sm-12 form-element">
				<div class='col-sm-2'>
					<input type="radio" name="invoice_reset" class="field-short invoice_reset" value="3" {if $setting.invoice_reset ==3}checked{/if}/>
					{l s='When the start of a year' mod='ba_prestashop_invoice'}
				</div>
			</div>
		</div>
	</div>
	...
	<div style="display: none;" class='form-group col-sm-12'>
		...
		<div class='col-sm-3'>
			<div class="form-element">
				...
				<p class="description">{l s='Shortcode: [counter] [m] [Y] [y] [d] - month, year, 2 digits of year, day from date of delivery' mod='ba_prestashop_invoice'}</p>
			</div>
		</div>
	</div>
	<div style="display: none;" class='form-group col-sm-12'>
		...
		<div class='col-sm-9'>
			...
			<div class="form-group col-sm-12 form-element">
				<div class='col-sm-2'>
					<input type="radio" name="delivery_reset" class="field-short invoice_reset" value="3" {if $setting.delivery_reset==3}checked{/if}/>
					{l s='When the start of a year' mod='ba_prestashop_invoice'}
				</div>
			</div>
		</div>
	...
	<div style="display: none;" class='form-group col-sm-12'>
		...
		<div class='col-sm-3'>
			<div class="form-element">
				...
				<p class="description">{l s='Shortcode: [counter] [m] [Y] [y] [d] - month, year, 2 digits of year, day from date of Credit' mod='ba_prestashop_invoice'}</p>
			</div>
		</div>
	</div>
	<div style="display: none;" class='form-group col-sm-12'>
		...
		<div class='col-sm-9'>
			...
			<div class="form-group col-sm-12 form-element">
				<div class='col-sm-2'>
					<input type="radio" name="credit_reset" class="field-short invoice_reset" value="3" {if $setting.credit_reset==3}checked{/if} />
					{l s='When the start of a year' mod='ba_prestashop_invoice'}
				</div>
			</div>
		</div>
	...
	<div style="display: none;" class='form-group col-sm-12'>
		...
		<div class='col-sm-3'>
			<div class="form-element">
				...
				<p class="description">{l s='Shortcode: [counter] [m] [Y] [y] [d] - month, year, 2 digits of year, day from date of order' mod='ba_prestashop_invoice'}</p>
			</div>
		</div>
	</div>
	<div style="display: none;" class='form-group col-sm-12'>
		...
		<div class='col-sm-9'>
			...
			<div class="form-group col-sm-12 form-element">
				<div class='col-sm-2'>
					<input type="radio" name="order_reset" class="field-short invoice_reset" value="3" {if $setting.order_reset==3}checked{/if} />
					{l s='When the start of a year' mod='ba_prestashop_invoice'}
				</div>
			</div>
		</div>
