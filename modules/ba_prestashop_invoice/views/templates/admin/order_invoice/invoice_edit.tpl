			...
			<div style="padding:0 10px;width:100%;float:left;">
				<h3 class="col-sm-12 panel-heading" style="margin:0 0 15px 0 !important;background: transparent;">
					...
					<span class="panel-heading-action">
						{foreach from=$toolBarBtn item=btn key=k}
							<a id="desc-{if isset($btn.imgclass)}{$btn.imgclass|escape:'htmlall':'UTF-8'}{else}{$k|escape:'htmlall':'UTF-8'}{/if}" class="list-toolbar-btn" {if isset($btn.href)}href="{$btn.href|escape:'htmlall':'UTF-8'}"{/if} {if isset($btn.target) && $btn.target}target="_blank"{/if}{if isset($btn.js) && $btn.js}onclick="{$btn.js|escape:'htmlall':'UTF-8'}"{/if}>
				...
				<div class="col-sm-12" style="margin-top:7px;">
					...
					<div class="col-sm-12" style="margin-bottom: 10px;">
						...
						<div class="col-sm-8">
							<div class="col-sm-12"><input style="float:left;" type="radio" name="useAdminOrClient" value="0" {if $invoiceTemplate.useAdminOrClient=="0"}checked=checked{/if}/><span style="margin-top:2px;display:block;">{l s='Admin and Client' mod='ba_prestashop_invoice'}</span></div>
							<div class="col-sm-12"><input style="float:left;" type="radio" name="useAdminOrClient" value="1" {if $invoiceTemplate.useAdminOrClient=="1"}checked=checked{/if}/><span style="margin-top:2px;display:block;">{l s='Admin' mod='ba_prestashop_invoice'}</span></div>
							<div class="col-sm-12"><input style="float:left;" type="radio" name="useAdminOrClient" value="2" {if $invoiceTemplate.useAdminOrClient=="2"}checked=checked{/if}/><span style="margin-top:2px;display:block;">{l s='Client' mod='ba_prestashop_invoice'}</span></div>
						</div>
					</div>
					<div class="col-sm-12" style="margin-bottom: 10px;">
