...
*}
<div class="panel ba_prestashop_invoice_panel_invoice">
	<div class="panel" style="float:left;width:100%;padding:0;">
				...
				<div class='form-group col-sm-6'>
					...
					<div class='col-sm-9'>
						<select name="colums_content[]">
							...
							<option value="27">{l s='Barcode for Product Reference' mod='ba_prestashop_invoice'}</option>
						</select>
					</div>
				</div>
				<div class='form-group col-sm-6'>
		...
		<form class="form-horizontal"  method="POST">
			<div style="padding: 0 10px;width:100%;float:left;">
				<h3 class="col-sm-12 panel-heading" style="margin:0 0 15px 0 !important;background: transparent;">
					<i class="icon-wrench"></i> {l s='General' mod='ba_prestashop_invoice'}
					<span class="panel-heading-action">
						{foreach from=$toolBarBtn item=btn key=k}
							<a id="desc-delivery-{if isset($btn.imgclass)}{$btn.imgclass|escape:'htmlall':'UTF-8'}{else}{$k|escape:'htmlall':'UTF-8'}{/if}" class="list-toolbar-btn" {if isset($btn.href)}href="{$btn.href|escape:'htmlall':'UTF-8'}"{/if} {if isset($btn.target) && $btn.target}target="_blank"{/if}{if isset($btn.js) && $btn.js}onclick="{$btn.js|escape:'htmlall':'UTF-8'}"{/if}>
				...
				<div class="col-sm-12" style="margin-top:7px;">
					...
					<div class="col-sm-12" style="margin-bottom: 10px;">
						<div class="col-sm-4 control-label" style="padding:0;font-size: 13px;">{l s='Use for Admin or Client' mod='ba_prestashop_invoice'}: </div>
						<div class="col-sm-8">
							<div class="col-sm-12"><input checked style="float:left;" type="radio" name="useAdminOrClient" value="0"/><span style="margin-top:2px;display:block;">{l s='Admin and Client' mod='ba_prestashop_invoice'}</span></div>
							<div class="col-sm-12"><input style="float:left;" type="radio" name="useAdminOrClient" value="1"/><span style="margin-top:2px;display:block;">{l s='Admin' mod='ba_prestashop_invoice'}</span></div>
							<div class="col-sm-12"><input style="float:left;" type="radio" name="useAdminOrClient" value="2"/><span style="margin-top:2px;display:block;">{l s='Client' mod='ba_prestashop_invoice'}</span></div>
						</div>
					</div>
					<div class="col-sm-12" style="margin-bottom: 10px;">
						<div class="col-sm-4 control-label" style="padding:0;font-size: 13px;">{l s='Language' mod='ba_prestashop_invoice'}: </div>
						<div class="col-sm-2">
							{include file="$_PS_MODULE_DIR_/ba_prestashop_invoice/views/templates/admin/select_language.tpl"}
						</div>
					</div>
					<div class="col-sm-12" style="margin-bottom: 10px;">
				...
				<div class="row list_token col-sm-12" rev="close" style="height:100px;overflow:hidden;margin-bottom: 20px;">
					...
					<div class="ba_invoice_token_wrapper">
						<label>[total_product_quantity]: </label>
						<label class="control-label">{l s='Total Quantity of Order' mod='ba_prestashop_invoice'}</label>
					</div>
							...
							<div class='form-group col-sm-6'>
								...
								<div class='col-sm-9'>
									<select name="colums_content[]">
										...
										<option value="15" {if $invoiceTemplate.columsContentJson.$i=="13"}selected{/if}>{l s='Tax Name' mod='ba_prestashop_invoice'}</option>
										...
										<option value="27" {if $invoiceTemplate.columsContentJson.$i=="27"}selected{/if}>{l s='Barcode for Product Reference' mod='ba_prestashop_invoice'}</option>
									</select>
								</div>
							</div>
							<div class='form-group col-sm-6'>
