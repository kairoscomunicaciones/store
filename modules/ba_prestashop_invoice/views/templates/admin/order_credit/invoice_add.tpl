		...
		<form class="form-horizontal"  method="POST">
			...
			<div style="width:100%;float:left;padding: 0 10px;">
				...
				<div class="row list_token col-sm-12" rev="close" style="height:100px;overflow:hidden;margin-bottom: 20px;">
					...
					<div class="ba_invoice_token_wrapper">
						<label>[credit_date]: </label>
						<label class="control-label">{l s='the date for create Credit Slip' mod='ba_prestashop_invoice'}</label>
					</div>
					<div class="ba_invoice_token_wrapper">
						<label>[credit_number]: </label>
						<label class="control-label">{l s='Credit Number, ex: 000001' mod='ba_prestashop_invoice'}</label>
					</div>
					<div class="ba_invoice_token_wrapper">
					...
					<div class="ba_invoice_token_wrapper">
						...
						<label class="control-label">{l s='Total Quantity of Credit Slip' mod='ba_prestashop_invoice'}</label>
					</div>
			...
			<div class="panel-footer">
				...
				<a id="preview_credit" class="btn btn-default pull-right">
