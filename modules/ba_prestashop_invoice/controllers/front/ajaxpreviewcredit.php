...
class Ba_prestashop_invoiceAjaxPreviewCreditModuleFrontController extends ModuleFrontController
{
    public $pdf_renderer;
    ...
    private function ajaxPreviewCredit()
    {
        ...
        echo $this->pdf_renderer->render("ba_credit_preview.pdf", 'F');
        @chmod(_PS_ROOT_DIR_.'/ba_credit_preview.pdf', 0755);
        die;
    }
