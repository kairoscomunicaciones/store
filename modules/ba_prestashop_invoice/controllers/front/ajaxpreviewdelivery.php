...
class Ba_prestashop_invoiceAjaxPreviewDeliveryModuleFrontController extends ModuleFrontController
{
    public $pdf_renderer;
    public function run()
    {
        ...
        if ($batoken == $cookiekey && !empty($id_employee)) {
            $this->ajaxPreviewDelivery();
        } else {
            echo $this->module->l('You do not have permission to access it.');
            die;
        }
    }
    private function ajaxPreviewDelivery()
    {
        $productsArr = array (
            '134' => array (
            ...
            '[tax_table]' => '
                <table id="table_tax" cellpadding="0" cellspacing="0">
                    ...
                    <tbody><tr>
                        ...
                        <td class="table_tax_content">10%</td><td class="table_tax_content">
                        $16.51</td><td class="table_tax_content">$1.65</td><td class="table_tax_content">$18.16</td>
                        </tr><tr>
                            <td class="table_tax_content">Products</td>
                        <td class="table_tax_content">5%</td><td class="table_tax_content">
                        $27.00</td><td class="table_tax_content">$1.35</td><td class="table_tax_content">$28.35</td>
                        </tr><tr>
                            <td class="table_tax_content">Products</td>
                        <td class="table_tax_content">15%</td><td class="table_tax_content">
                        $26.00</td><td class="table_tax_content">$3.90</td><td class="table_tax_content">$29.90</td>
                        </tr></tbody>
                </table>
                ',
        ...
        @unlink(_PS_ROOT_DIR_.'/ba_delivery_preview.pdf');
        ...
        echo $this->pdf_renderer->render("ba_delivery_preview.pdf", 'F');
        @chmod(_PS_ROOT_DIR_.'/ba_delivery_preview.pdf', 0755);
        die;
    }
