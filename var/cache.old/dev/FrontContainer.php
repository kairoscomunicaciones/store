...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'inveriti_pres963', 'user' => 'inveriti_pres963', 'password' => 'd7fC=(AdMl4$', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/home2/inveriti/public_html/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/home2/inveriti/public_html/modules/productcomments/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/home2/inveriti/public_html/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/home2/inveriti/public_html/var/cache/dev//doctrine/orm/Proxies');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/home2/inveriti/public_html/var/cache/dev//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/home2/inveriti/public_html/var/cache/dev//localization'))) && false ?: '_'});
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'database_port' => '',
            'database_name' => 'inveriti_pres963',
            'database_user' => 'inveriti_pres963',
            'database_password' => 'd7fC=(AdMl4$',
            ...
            'kernel.root_dir' => '/home2/inveriti/public_html/app',
            'kernel.project_dir' => '/home2/inveriti/public_html',
            'kernel.name' => 'app',
            'kernel.debug' => true,
            'kernel.environment' => 'dev',
            'kernel.cache_dir' => '/home2/inveriti/public_html/var/cache/dev/',
            ...
            'ps_cache_dir' => '/home2/inveriti/public_html/var/cache/dev/',
            ...
            'doctrine.orm.proxy_dir' => '/home2/inveriti/public_html/var/cache/dev//doctrine/orm/Proxies',
