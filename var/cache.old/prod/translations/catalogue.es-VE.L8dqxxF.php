...
$catalogue = new MessageCatalogue('es-VE', array (
  'AdminActions' => 
  array (
    ...
    'Reorder' => 'Realizar pedido nuevamente',
  ...
  array (
    ...
    'Mail to' => 'Correo para',
    'You cannot add more than %d product(s) to the product comparison' => 'No puede agregar más de %d producto(s) a la comparación de productos',
    'Please select at least one product' => 'Por favor seleccione al menos un producto',
    'Product available with different options' => 'Por favor seleccione al menos un producto',
    'Out of stock' => 'no disponible',
    'In Stock' => 'Disponible',
    'Reduced price!' => 'Precio reducido',
    'Online only' => 'Solamente en lìnea',
    'Sale!' => 'Oferta',
    'New' => 'Nuevo',
  ...
  array (
    ...
    'Address:' => 'Dirección',
    'Featured [1]Products[/1]' => 'Productos [1]Destacados[/1]',
    'New' => 'Nuevo',
    'New Products' => 'Nuevos',
    ' New Arriavals' => 'Recién llegados',
    'Specials' => 'Especiales',
    'Best Sellers' => 'Los más vendidos',
    'Follow us:' => 'Síguenos',
    'Sign up to our newsletter: ' => 'Suscríbete a nuestro boletín de noticias',
    ...
    'Not you? [1]Log out[/1]' => 'No eres tu?  [1]Salir de la Cuenta[/1]',
    'Sign out' => 'Salir',
    'Shopping Cart' => 'Carrito de Compra',
    'Shopping Cart:' => 'Carrito de Compra',
    'Next' => 'Próximo',
    'Previous' => 'Previo',
    'Store Locator' => 'Localizador de tienda',
    'Order Confirmation' => 'Confirmación de la Orden',
    'Contact' => 'Contacto',
    'Stores' => 'Tiendas',
    'Sorry for the inconvenience.' => 'Ten un poco de paciencia...mientras,',
    ...
    'Add' => 'Añadir',
    'Cancel' => 'Cancelar',
    'Take advantage of our exclusive offers:' => 'Tome ventaja de nuestras exclusivas ofertas',
    'Continue' => 'Continuar',
    'Checkout' => 'Finalizar la compra',
    'List of pages in %name%:' => 'Lista de páginas en %name%',
    'List of sub categories in %name%:' => 'Lista of sub categories in %name%:',
    'Sitemap' => 'Mapa del sitio',
    'Our stores' => 'Nuestras tiendas ',
    'Request a return' => 'Solicitar una devolución',
    'Update' => 'Actualizar',
    'If you would like to add a comment about your order, please write it in the field below.' => 'Si desea agregar un comentario sobre su pedido, escríbalo en el campo a continuación.',
    'Delete' => 'Eliminar',
    'Returned' => 'Devuelto',
    'If you wish to return one or more products, please mark the corresponding boxes and provide an explanation for the return. When complete, click the button below.' => 'si desea devolver uno o más productos, marque las casillas correspondientes y proporcione una explicación de la devolución. Cuando termine, haga clic en el botón de abajo.',
    'Merchandise return' => 'Devolución de Mercancía',
    'About and Contact' => 'Sobre nosotros y contacto',
    'TOP' => 'Tope',
    'Search again what you are looking for' => 'Intenta buscar otro producto ',
    ...
    'No account? Create one here' => '¿Aún no tienes cuenta? . Create una',
    'Log in to your account' => 'Ingresa en tu cuenta',
    'Your account' => 'Tu cuenta',
    'Here are the orders you\'ve placed since your account was created.' => 'Estos son los pedidos que has realizado desde que se creó tu cuenta.',
    'Create an account' => 'Crear una cuenta',
    'Already have an account?' => '¿Ya tienes una cuenta?',
    'Back to your account' => 'Regresa a tu cuenta',
    'Transform your guest account into a customer account and enjoy:' => 'Transforma tu cuenta de invitado en una cuenta de cliente y disfrute de:',
    'Log in to your customer account' => 'Ingresa a tu cuenta de cliente',
    'my account' => 'mi cuenta',
    'Forgot your password?' => '¿Olvidaste tu contraseña? ',
    'Log in instead!' => 'Ingresa a tu cuenta',
    'Sort by:' => 'Ordenar por:',
    'Order history' => 'Historial de pedidos',
    'Order history and details' => 'Historial y detalle de pedidos',
    ...
    'You cannot access this store from your country. We apologize for the inconvenience.' => 'No puedes acceder a esta tienda desde tu país. Pedimos disculpas por las molestias.',
...
Aquí hay una lista de devoluciones de mercancías pendientes',
    'Create new address' => 'Crear nueva dirección',
    'Easier merchandise return' => 'Devolución de mercancia más fácil',
    'Fast and easy checkout' => 'Verificación rápida y fácil',
    'Personalized and secure access' => 'Acceso seguro y personalizado',
    'Guest Tracking' => 'Seguimiento de invitados',
    'Reorder' => 'Reordenar',
    'Details' => 'Detalles',
    'If the conditions of return listed above are not respected, we reserve the right to refuse your package and/or reimbursement.' => 'Si no se respetan las condiciones de devolución enumeradas anteriormente, nos reservamos el derecho de rechazar su paquete y/o reembolso.
',
    'Please let us know if you have any questions.' => 'Por favor, háganos saber si usted tiene alguna pregunta.',
    'When we receive your package, we will notify you by email. We will then begin processing order reimbursement.' => 'Cuando recibamos su paquete, se lo notificaremos por correo electrónico. Luego comenzaremos a procesar el reembolso del pedido.',
    'Please check the [1]returns form[/1] for the correct address.' => 'Consulte el [1]formulario de devoluciones[/1] para obtener la dirección correcta.',
    'Please print out the [1]returns form[/1] and include it with your package.' => 'Imprima el [1]formulario de devolución[/1] e inclúyalo con su paquete.
',
    'All merchandise must be returned in its original packaging and in its original state.' => 'Toda la mercancía debe ser devuelta en su embalaje original y en su estado original.',
    'Reminder' => 'Recordatorio',
    'List of items to be returned:' => 'Lista de artículos a devolver:',
    'Send' => 'Enviar',
    'OK' => 'OK',
    'Subscribe' => 'Suscribir',
    'Sign in' => 'Iniciar Sesión',
    ...
    'Remove' => 'Retirar',
    'remove from cart' => 'retirar del carrito',
    'Continue shopping' => 'Continuar comprando',
    'Quick view' => '
Vista rápida',
    'Home' => 'Inicio',
    'Save' => 'Guardar',
    'Your personal information' => 'Tu información personal',
    'Your vouchers' => 'Tus vales',
    'Update your address' => 'Actualiza tu dirección',
    'Back to login' => 'Atrás para iniciar sesión',
    'Send reset link' => 'Enviar enlace de reinicio',
    'Click the following link to track the delivery of your order' => 'Haga clic en el siguiente enlace para realizar un seguimiento de la entrega de su pedido',
    'Status' => 'Estado',
    'Date' => 'Fecha',
    'Follow your order\'s status step-by-step' => 'Siga paso a paso, el estado de su pedido',
    'Message' => 'Mensaje',
    'You have requested gift wrapping for this order.' => 'Ha solicitado un envoltorio de regalo para este pedido.',
    'You have given permission to receive your order in recycled packaging.' => 'Has dado permiso para recibir tu pedido en envases reciclados.',
    'Download your invoice as a PDF file.' => '
Descargue su factura en formato PDF.',
    'Order Reference %reference% - placed on %date%' => 'Referencia de pedido %reference% - realizado en la %date%',
    'Order details' => 'Detalles del pedido',
    'For example: QIIXJXNUI or QIIXJXNUI#1' => 'Por ejemplo: QIIXJXNUI o QIIXJXNUI#1',
    'To track your order, please enter the following information:' => 'Para rastrear su pedido, por favor ingrese la siguiente información:',
    'Guest Order Tracking' => 'Seguimiento de pedidos de invitados',
    'The current status of your merchandise return is: [1] %status% [/1]' => 'El estado actual de su devolución de mercancía es: [1] %estado% [/1]',
    'Your package must be returned to us within %number% days of receiving your order.' => 'Su paquete debe ser devuelto dentro de los %numero% días posteriores a la recepción de su pedido.',
    'We have logged your return request.' => 'Hemos registrado su solicitud de devolución.',
    '%number% on %date%' => '%número% en %fecha%',
...
Dirección de correo electrónico: %correo%',
    ...
    'View credit slip' => 'Ver comprobante de crédito',
    'Share' => 'Compartir',
    'Credit slips' => 'Comprobantes de credito',
    'Credit slips you have received after canceled orders' => ' Comprobantes de crédito que recibiste después de cancelar los pedidos',
    'Order' => 'Pedido',
    'Credit slip' => 'Comprobante de crédito',
    'Date issued' => 'Fecha de emisión',
    'Address: [1]%address%[/1]' => 'Address: [1]%address%[/1]',
    'Address2: [1]%address2%[/1]' => 'Address2: [1]%address2%[/1]',
    'Address: [1]%address1%[/1]' => 'Address: [1]%address1%[/1]',
  ...
  array (
    ...
    '%1$s: ' => '%1$s:',
    '(not impacted by the discount)' => '(No afectado por el descuento)',
    'Instead of %price%' => 'En lugar de %precio%',
    '%price% tax excl.' => '%precio% impuestos excluidos.',
    'Condition' => 'Condición',
    'Specific References' => 'Referencias específicas',
    'Data sheet' => 'Ficha de datos',
    'Availability date:' => 'Fecha disponible:',
    'In stock' => 'En stock',
    'Brand' => 'Marca',
    'Up to %discount%' => 'Hasta %descuento%',
    ...
    'Product customization' => 'Personalización de producto',
    'Reference' => 'Referencia',
    'Product' => 'Producto',
    'Next' => 'Siguiente',
    'Back' => 'Volver',
    'Start shopping now' => 'Emepezar a comprar ahora',
    'Including %amount% for ecotax' => 'incluyendo %monto% for ecotax',
    '(%unit_price%)' => '(%unit_price%)',
    'Detalle del producto' => 'Detalle del producto',
    'Detalle del médico' => 'Detalle del médico',
    'Discount' => 'Descuento',
  ...
  array (
    'Wire payment' => 'Pagos por pago Movil',
    'Accept payments by bank transfer.' => 'Aceptar pagos mediante Pago Móvil bancario.',
    'Accept wire payments by displaying your account details during the checkout and make it easy for your customers to purchase on your store.' => 'Aceptar pagos por Pago Mòvil bancario mostrando los detalles de tu cuenta durante el proceso de pago, haciendo más fácil para tus clientes comprar en tu tienda.
',
    'Accept wire payments by displaying your account details during the checkout.' => 'Acepte pagos por Pago Móvil mostrando los detalles de su cuenta durante el pago.',
    'Information on the bank transfer (processing time, starting of the shipping...)' => 'Información sobre el pago Móvil Bancario (tiempo de procesado, iniciación del proceso de envío...)',
  ...
  array (
    'Pay by bank wire' => 'Pago el dia de la Cita ',
    'Please transfer the invoice amount to our bank account. You will receive our order confirmation by email containing bank details and order number.' => 'Solo en caso de Citas Medicas o Servicio Automotriz',
  ...
  array (
    'Amount' => 'Total',
    'Send your check to this address' => 'Transferencia a la siguiente cuenta',
    'Pay by check' => 'Pago por Transferencia Bancaria',
    'Please send us your check following these rules:' => 'Por favor, envíenos su transferencia con las siguientes indicaciones:',
    'Your check must include:' => 'Gracias por su pago',
    'Your order will be sent as soon as we receive your payment.' => 'Le enviaremos su pedido en cuanto confirmemos el pago.',
    'Do not forget to insert your order reference %s.' => 'La referencia de su pedido %s.',
    'This payment method is not available.' => 'Este método de pago no está disponible.',
    'Payee' => 'Beneficiario',
    '(order processing will be longer)' => '(el trámite del pedido tomará más tiempo)',
    'Your order on %s is complete.' => 'Su pedido en %s se ha completado.',
  ...
  array (
    'Pay by Check' => 'Transferencia Bancaria',
    'Payments by check' => 'Pagos por Transferencia Bancaria',
    'This module allows you to accept payments by check.' => 'Este módulo te permite aceptar pagos por transferencia bancaria',
  ...
  'ShopThemeCheckout' => 
  array (
    'Check Out' => 'Finalizar la compra',
    'Shipping Method' => 'Método de envío',
    'Shipping cost' => 'Costo de envío',
    'Total shipping:' => 'Total envío',
    'Shipping method: %method%' => 'Método de envío %method%',
    'Shipping Address' => 'Dirección de envío',
    'Billing address differs from shipping address' => 'Dirección de cobro distinta de la de envío',
    'Addresses' => 'Direcciones',
    'The selected address will be used both as your personal address (for invoice) and as your delivery address.' => 'La dirección seleccionada se utilizará tanto como su dirección personal (para la factura) como su dirección de entrega.',
    'If you sign out now, your cart will be emptied.' => 'Si cierra sesión ahora, su carrito se vaciará.',
    'Order with an obligation to pay' => 'Completar el pedido',
    'The minimum purchase order quantity for the product is %quantity%.' => 'La cantidad mínima de pedido de compra para el producto es %quantity%.',
    '%products_count% items in your cart' => '%products_count% artículos en tu carrito',
    '%product_count% item in your cart' => '%products_count% artículos en tu carrito',
    'The selected address will be used as your personal address (for invoice).' => 'La dirección seleccionada se utilizará como su dirección personal (para la factura).',
    'Unfortunately, there are no carriers available for your delivery address.' => 'Desafortunadamente, no hay transportistas disponibles para su dirección de entrega.',
    'Promo code' => 'Código promocional',
    'Please check your order before payment' => 'Comprueba tu pedido antes de realizar el pago.',
    'edit' => 'Editar',
    'Your Delivery Address' => 'Su dirección de despacho',
    'Your Invoice Address' => 'Su dirección de facturación',
    'There are no more items in your cart' => '
No hay más artículos en su carrito',
    'Order items' => 'Artículos ordenados',
    'Gift' => 'Regalo',
    'Selected' => 'Seleccionada',
    'Unfortunately, there are no payment method available.' => 'Desafortunadamente, no hay ningún método de pago disponible. Intente comprar por separado productos y servicios',
    'By confirming the order, you certify that you have read and agree with all of the conditions below:' => 'Al confirmar el pedido, certifica que ha leído y está de acuerdo con todas las condiciones a continuación:',
    'Description' => 'Descripción',
    'Code' => 'Código',
    'Tracking number' => 'Número de rastreo',
    'Weight' => 'Peso',
    'Invoice address %alias%' => 'Dirección de facturación %alias%',
    'Delivery address %alias%' => 'Dirección de despacho %alias%',
    ...
    'Total price' => 'Precio Total',
    'Date' => 'Fecha',
    'Order reference' => 'Referencia de la orden',
    'Quantity' => 'Cantidad',
    'Shopping Cart' => 'Carrito de Compra',
    'Total:' => 'Total',
    'Total products:' => 'Productos totales',
    'There is %product_count% item in your cart.' => 'Hay %product_count%  artículos en tu carrito',
    'There are %products_count% items in your cart.' => 'Hay %products_count% artículos en tu carrito',
    'Have a promo code?' => '¿Tiene un código promocional?',
    'Use this address for invoice too' => 'Use esta dirección para facturar también',
    'And save time on your next order!' => '¡Y ahorra tiempo en tu próximo pedido!',
    '(optional)' => '(opcional)',
    'Create an account' => 'Cree una cuenta',
    'Save time on your next order, sign up now' => 'Ahorra tiempo en tu próximo pedido, regístrate ahora',
    'Value' => 'Valor',
    'Minimum' => 'Mínimo',
    'Cumulative' => 'Acumulado',
    'Expiration date' => 'Fecha de vencimiento',
    'Your order is confirmed' => 'Su orden está confirmada',
    'Order details' => 'Detalles de la orden',
    'Payment method: %method%' => 'Referencia del pago',
    'An email has been sent to your mail address %email%.' => 'Se ha enviado un correo electrónico a su dirección %email%.',
    'Código de Validación no se encuentra. El registro no pudo ser completado, intente nuevamente con un código vàlido.' => 'Código de Validación no se encuentra. El registro no pudo ser completado, intente nuevamente con un código válido.',
    'Order as a guest' => '
Ordenar como invitado',
    'If you\'d like, you can add a note to the gift:' => 'Si lo desea, puede agregar una nota al regalo:',
    'I would like to receive my order in recycled packaging.' => 'Me gustaría recibir mi pedido en envases reciclados.',
    'Please make sure you\'ve chosen a [1]payment method[/1] and accepted the [2]terms and conditions[/2].' => 'Asegúrese de haber elegido un [1]método de pago[/1] y de haber aceptado los [2]términos y condiciones[/2].',
    'Order reference: %reference%' => 'Referencia del pedido: %reference%',
    'You can also [1]download your invoice[/1]' => 'También puede [1]descargar su factura[/1]',
    'Quantity:' => 'Cantidad',
    'Product successfully added to your shopping cart' => 'Producto agregado exitosamente a su carrito de compras',
    ...
    'Tax included' => 'Incluye IVA',
    'Tax excluded' => 'No incluye IVA',
    ...
    'If you would like to add a comment about your order, please write it in the field below.' => 'Si deseas dejar un comentario sobre tu pedido, por favor escríbelo en el siguiente campo.',
  ),
  'ModulesYbcwidgetWidgets' => 
  array (
    'Company' => 'Compañía',
  ),
  'ModulesCategoryproductsShop' => 
  array (
    '%s other products in the category' => '%s otros productos en esa categoría',
    '%s other product in the category' => '%s otros productos en esa categoría',
    '%s other product in the same category:' => '%s otro producto en la misma categoría:',
    '%s other products in the same category:' => '%s otros productos en la misma categoría:',
  ),
  'ModulesCashondeliveryAdmin' => 
  array (
    'Cash on delivery (COD)' => 'Pago en efectivo',
    'Accept cash on delivery payments' => 'Aceptar pagos en efectivo',
  ),
  'ModulesCashondeliveryShop' => 
  array (
    'Pay by Cash on Delivery' => 'Pago en efectivo',
    'You have chosen the cash on delivery method.' => 'Ha elegido el pago en efectivo',
    'Your order will be sent very soon.' => 'Le enviaremos su pedido a la brevedad',
    'You pay for the merchandise upon delivery' => 'Gestionaremos el pago al momento de la  entrega',
    'Your order on %s is complete.' => 'Su pedido en %s se ha completado.',
    'For any questions or for further information, please contact our' => 'Para cualquier pregunta o para más información, contacte con nuestro',
    'customer support' => 'servicio de atención al cliente',
  ),
  'ModulesEtsmultilayersliderMultilayerslider' => 
  array (
    'Next' => 'Siguiente',
    'No active slides available' => 'No hay diapositivas activas disponibles',
    'Prev' => 'Anterior',
  ),
  ...
  array (
    ...
    'Be the first to write your review' => 'Sé el primero en escribir tu reseña.',
    'Write your review' => 'Escribe tu reseña',
    '%1$d out of %2$d people found this review useful.' => '%1$d de %2$d personas encontraron útil esta reseña.',
    'Grade' => 'Calificación',
    'OK' => 'OK',
    'New comment' => 'Nuevo comentario',
    'Your comment has been submitted and will be available once approved by a moderator.' => 'Su comentario ha sido enviado y estará disponible una vez que sea aprobado por un moderador.',
  ...
  'ModulesYbcblogfreeGallery' => 
  array (
    'No item found' => 'No se encontro el artículo',
    'Blog gallery' => 'Galeria del blog',
  ),
  'ModulesYbcthemeconfigBlocksocial' => 
  array (
    'Instagram' => 'Instagram',
    'Vimeo' => 'Vimeo',
    'Pinterest' => 'Pinterest',
  ...
  'ModulesYbcthemeconfigPanel' => 
  array (
    'The product has been removed from comparison' => 'El producto ha sido eliminado de la comparación.',
    'View all products' => 'Ver todos los productos',
    'The product has been successfully added to comparison' => 'El producto se ha añadido con éxito a la comparación.',
    'Reset to default' => 'Restablecer a los predeterminados',
    'Background image' => 'Imagen de fondo',
    'No' => 'No',
    'Yes' => 'Sí',
    'Float header' => 'Encabezado flotante',
    'Theme color' => 'Color del tema',
    'Theme options' => 'Opciones del tema',
    'Updating...' => 'Actuañozando...',
    'Loading' => 'Cargando...',
    'Theme Option' => 'Opción del tema',
...
Ningún archivo seleccionado',
    '250 char. max' => '250 caracteres máximo',
    'Your message here' => 'Su mensaje está aquí',
    'Don\'t forget to save your customization to be able to add to cart' => 'No olvides guardar tu personalización para poder añadir al carrito',
  ...
  'ModulesYbcwidgetForm' => 
  array (
    'Cancel' => 'Cencelar',
    'Do you want to delete this image?' => '¿Quieres eliminar esta imagen?',
    'Click to see full size image' => 'Haga clic para ver la imagen a tamaño completo',
    'Uploaded image: ' => 'Imagen cargada:',
  ),
  'ModulesYbcwidgetMainform' => 
  array (
    'Enable this item' => 'Habilitar este artículo',
    'Disable this item' => 'Deshabilitar este artículo',
    'Do you want to delete this?' => '¿Quieres eliminar esto?',
    'Add a widget to this hook' => 'Agregar un widget a este gancho',
    'Add new widget' => 'Agregar nuevo widget',
    'Widgets' => 'Widgets',
  ),
  'ModulesYbcwidgetYbcwidget' => 
  array (
    'Enable this item' => '
Habilitar este elemento',
    ...
    'Add a widget to this hook' => 'Agregar un widget a este gancho',
    'Widgets' => 'Widgets',
    'The item could not be updated.' => 'No se pudo actualizar el artículo.',
    'The item could not be added.' => 'No se pudo agregar el artículo.',
    'An error occurred during the image upload process.' => 'Ocurrió un error durante el proceso de carga de la imagen.',
    'Can not upload the file' => 'No se puede cargar el archivo',
    'Image file name already exists. Try to rename the file name then reupload it' => 'El nombre del archivo de imagen ya existe. Intente cambiar el nombre del archivo y luego vuelva a cargarlo',
    'Title is required' => 'Se requiere título',
    'Link is not vaild' => 'El enlace no es válido',
    'Awesome icon is not vaild' => 'El ícono impresionante no es válido',
    'Hook is not valid' => 'El gancho no es válido',
    'Please choose a hook' => 'Por favor elige un gancho',
    'Could not delete the widget. Please try again' => 'No se pudo eliminar el widget. Inténtalo de nuevo',
    'Widget does not exist' => 'El widget no existe',
    'Image does not exist' => 'La imagen no existe',
    '-- Choose a hook --' => '-- Elige un gancho --',
    'Save' => 'Guardar',
    'Hook Right Column' => 'Gancho Columna Derecha',
    'Hook Left Column' => 'Gancho de la columna izquierda',
    'Hook Top' => 'Gancho superior',
    'Hook Top Navigation' => 'Gancho de navegación superior',
    'Hook Home' => 'Gancho de inicio',
    'Hook Top Column' => 'Gancho de columna superior',
    'Add custom HTML widgets to various postions on frontend' => 'Agregue widgets HTML personalizados a varias posiciones en la interfaz
',
    'Enabled' => 'Habilitado',
    ...
    'Eg: fa-home, fa-phone' => 'Ej: fa-casa, fa-teléfono',
    'Awesome icon' => 'Icono de afirmación',
    'Image' => 'Imagen',
    'Description' => 'Descripción',
    'Hook' => 'Gancho',
    'Sub Title' => 'Subtítulo',
...
',
    ...
    'link menu top nav' => 'menú de enlace navegación superior',
    'Hook Footer' => 'Gancho de pie de página',
  ),
  'ModulesYbcblogfreeExport' => 
  array (
    'Import data' => 'Datos de importacion',
    'Override existing data' => 'Anular datos existentes',
    'Data package' => 'Paquete de datos',
    'Import blog data' => 'Importar datos de blogs',
    'Export all blog data including blog images, text, custom CSS and configuration' => 'Exporte todos los datos del blog, incluidas las imágenes del blog, el texto, el CSS personalizado y la configuración',
    'Export blog' => '
Exportar blog',
    'Export blog content' => '
Exportar contenido del blog',
    'Export/Import' => 'Exportar/importar',
    'Import successfull' => 'Importación exitosa',
  ),
  'ModulesYbcblogfreeForm' => 
  array (
    'Add new item ' => 'Añadir nuevo artículo',
    'Loading' => 'Cargando',
    'Back' => 'Volver',
    'Click to see full size image' => 'Haga clic para ver la imagen a tamaño completo',
    'Uploaded image: ' => 'Imagen cargada:',
  ),
  'ModulesYbcblogfreeYbcblogfree' => 
  array (
    'This comment has been reported' => 'Este comentario ha sido reportado',
    'Successfully reported' => 'Reportado con éxito',
    'Please login to report this comment' => 'Por favor inicia sesión para reportar este comentario',
    'You are not allowed to report this comment' => '
No tienes permiso para reportar este comentario.',
    'This comment does not exist' => 'Este comentario no existe',
    'You have liked this post' => 'Te ha gustado esta publicación',
    'Successfully liked the post' => 'Me gustó la publicación',
    'You need to login to like the post' => 'Necesitas iniciar sesión para dar me gusta a la publicación',
    'You are not allowed to like the post' => 'No puedes darle me gusta a la publicación.',
    'and waiting for approval' => 'y esperando la aprobación',
    'and approved' => 'y aprobado',
    'Comment has been submitted ' => 'El comentario ha sido enviado',
    'Security code is invalid' => 'El codigo de seguridad es inválido',
    'This post does not exist' => 'Esta publicación no existe',
    'Rating need to be from 1 to 5' => 'La calificación debe ser de 1 a 5',
    'You need to log in before posting a comment' => 'Debes iniciar sesión antes de publicar un comentario.',
    'Subject can not be longer than 2000 characters' => 'El asunto no puede tener más de 2000 caracteres',
    'Invalid email address' => 'Dirección de correo electrónico no válida',
    'Name is required' => 'Se requiere el nombre',
    'Neither blog-data.xml exist' => 'Tampoco existe el blog-data.xml',
    'Title is required' => 'Se requiere el título',
    'Could not delete the item. Please try again' => 'No se pudo eliminar el elemento. Inténtalo de nuevo',
    'Item does not exist' => 'El artículo no existe',
    'Image is  empty' => 'La imagen esta vacia',
    'Recommended size: 600x600' => 'Tamaño recomendado: 600x600',
    'Title' => 'Título',
    'Manage blog galleryr' => 'Administrar galería de blogs',
    'View slider on blog page' => 'Ver control deslizante en la página del blog',
    'Slide saved' => 'Diapositiva guardada',
    'The slide could not be updated.' => 'No se pudo actualizar la diapositiva.
',
    'The slide could not be added.' => 'No se pudo agregar la diapositiva.',
    'You need to set caption' => 'Necesitas establecer un pie de foto',
    'You need to upload an image' => 'Tienes que subir una imagen',
    'Could not delete the slide. Please try again' => 'No se pudo eliminar la diapositiva. Inténtalo de nuevo',
    'Slide does not exist' => 'La diapositiva no existe',
    'Recommended size: 800x470' => 'Tamaño recomendado: 800x470',
    'Manage blog slider' => 'Administrar el control deslizante del blog',
    'Caption' => 'Pie de foto',
    'Reply to this comment' => 'Responder a este comentario ',
    'Comment need to be clean HTML' => 'El comentario debe ser HTML limpio',
    'Comment need to be at least 20 characters' => 'El comentario debe tener al menos 20 caracteres.',
    'Subject need to be clean HTML' => 'El asunto debe ser HTML limpio',
    'Subject can not be longer than 300 characters' => 'El asunto no puede tener más de 300 caracteres',
    'Subject need to be at least 10 characters' => 'El asunto debe tener al menos 10 caracteres',
    'Could not delete the comment. Please try again' => 'No se pudo eliminar el comentario. Inténtalo de nuevo',
    'Comment does not exist' => 'El comentario no existe',
    'There was a problem while submitting your request. Try again later' => 'Hubo un problema al enviar su solicitud. Vuelva a intentarlo más tarde',
    'Configuration saved' => 'Configuración guardada',
    'One of the sumitted emails is not valid' => 'Uno de los correos electrónicos enviados no es válido',
    'Number of image per page need to be greater than 0' => 'El número de imágenes por página debe ser mayor que 0',
    'Post excerpt length cannot be smaller than 0' => 'La longitud del extracto de la publicación no puede ser inferior a 0',
    'Maximum number of tags displayed on Tags block need to be greater than 0' => 'El número máximo de etiquetas que se muestran en el bloque de etiquetas debe ser mayor que 0',
    'Number of items per page need to be greater than 0' => 'El número de elementos por página debe ser mayor que 0',
    'Default rating must be between 1 - 5' => 'La calificación predeterminada debe estar entre 1 y 5',
    'Maximum number of latest comments displayed need to be from 0' => 'El número máximo de últimos comentarios mostrados debe ser de 0',
    'Gallery thumbnail height need to be from 50 to 1000' => 'La altura de la miniatura de la galería debe ser de 50 a 1000',
    'Gallery thumbnail width need to be from 50 to 1000' => 'El ancho de la miniatura de la galería debe ser de 50 a 1000
',
    'Number of images on gallery block need to be greater than 0' => 'El número de imágenes en el bloque de la galería debe ser mayor que 0',
    'Number of popular posts displayed need to be greater than 0' => 'El número de publicaciones populares mostradas debe ser mayor que 0',
    'Post saved' => 'Publicación guardada',
    'The post could not be updated.' => 'No se pudo actualizar la publicación.',
    'The post could not be added.' => 'No se pudo agregar la publicación.',
    'Thumbnail image is invalid' => '
La imagen en miniatura no es válida',
    'An error occurred during the thumb upload process.' => 'Se produjo un error durante el proceso de carga de miniaturas.',
    'Image is invalid' => 'La imagen no es válida',
    'Likes is not valid' => 'Me gusta no es válido',
    'Likes is required' => 'El me gusta es obligatorio
',
    'Views is not valid' => 'Las vistas no son validas',
    'Views is required' => 'Las vistas son obligatorias',
    'You need to choose at least 1 category' => 'Debes elegir al menos 1 categoría',
    'You need to set blog post short description' => 'Necesitas establecer una breve descripción de la publicación del blog',
    'You need to set blog post title' => 'Necesitas establecer el título de la publicación del blog',
    'Products is not valid' => 'Los productos no son válidos',
    'Likes can not be smaller than 0' => 'Los me gusta no pueden ser menores a 0',
    'Views can not be smaller than 0' => 'Las vistas no pueden ser menores a 0',
    'Could not delete the post. Please try again' => 'No se pudo eliminar la publicación. Inténtalo de nuevo',
    'Post does not exist' => 'La publicación no existe',
    'Image deleted' => 'Imágen eliminada',
    'Thumbnail image does not exist' => 'La imagen en miniatura no existe',
    'Category updated' => 'Categoría actualizada',
    'The category could not be updated.' => 'No se pudo actualizar la categoría.',
    'The category could not be added.' => 'No se pudo agregar la categoría.',
    'An error occurred during the image upload process.' => 'Ocurrió un error durante el proceso de carga de la imagen.',
    'Can not upload the file' => 'No se puede cargar el archivo',
    'Sort order is not valid' => 'El orden de clasificación no es válido',
    'Sort order is required' => 'Se requiere orden de clasificación',
    'Url alias is required' => 'Se requiere alias de Url',
    'You need to set blog category title' => 'Necesitas establecer el título de la categoría del blog',
    'Could not delete the category. Please try again' => 'No se pudo eliminar la categoría. Inténtalo de nuevo',
    'Category does not exist' => '
La categoría no existe',
    'Image does not exist' => 'La imagen no existe',
    'Category image deleted' => 'Imagen de categoría eliminada',
    'Save' => 'Guardar',
    'Recommended size: 1920x750' => 'Tamaño recomendado: 1920x750',
    'Image' => 'Imágen',
    'To add "keywords" click in the field, write something, and then press "Enter."' => 'Para agregar "palabras clave", haga clic en el campo, escriba algo y luego presione "Enter".',
    'Meta keywords' => 'Metapalabras clave',
    'Invalid characters:' => 'Carácteres inválidos',
    'RTL mode' => 'Modo RTL',
    'Post excerpt length' => 'Longitud del extracto de la publicación',
    'Number of posts per page on inner pages' => 'Número de publicaciones por página en páginas internas',
    'Number of posts per page on main page' => 'Número de publicaciones por página en la página principal
',
    'Show post categories' => 'Mostrar categorías de publicaciones',
    'Show post tags' => 'Mostrar etiquetas de publicaciones',
    'Show post author' => 'Mostrar autor de la publicación',
    'Show post publish date' => 'Mostrar fecha de publicación de la publicación',
    'Show post views' => 'Mostrar vistas de publicaciones',
    'Enable Twitter share' => 'Habilitar compartir en Twitter',
    'Enable Google Plus share' => '
Habilitar compartir con Google Plus',
    'Enable Facebook share' => 'Habilitar compartir en Facebook',
    'Default rating' => 'Calificación predeterminada',
    'Allow vistor to rate a post in their comment' => 'Permitir que el visitante califique una publicación en su comentario',
    'Allow vistor to report a comment' => 'Permitir que el visitante reporte un comentario',
    'Set 0 if you want to show all comments of each post' => 'Establezca 0 si desea mostrar todos los comentarios de cada publicación',
    'Maximum number of latest comments displayed' => 'Número máximo de últimos comentarios mostrados',
    'Auto approved comments' => 'Comentarios aprobados automáticamente',
    'Use capcha security for comment' => 'Use la seguridad de capcha para comentar',
    'Allow guests comments' => 'Permitir comentarios de invitados',
    'Default' => 'Predeterminado',
    'Gallery slideshow effect' => 'Efecto de presentación de diapositivas de la galería
',
    'Enable gallery slideshow' => 'Habilitar presentación de diapositivas de la galería',
    'Number of images on gallery block' => 'Número de imágenes en el bloque de la galería',
    'Display control buttons' => 'Mostrar botones de control',
    'Display caption' => 'Mostrar pie de foto',
    'Slider speed' => 'Velocidad del control deslizante',
    'Auto play slider' => 'Control deslizante de reproducción automática',
    'Display slider' => 'Mostrar deslizador',
    'Enable carousel slider for featured gallery images block' => 'Habilitar el control deslizante del carrusel para el bloque de imágenes de la galería destacada
',
    'Display feature posts' => 'Mostrar características de publicaciones',
    'Maximum number of popular posts displayed' => 'Número máximo de publicaciones populares mostradas',
    'Display popular posts' => 'Mostrar publicaciones populares',
    'Maximum number of latest posts displayed' => 'Número máximo de últimas publicaciones mostradas',
    'Display latest posts' => 'Mostrar últimas publicaciones',
    'Type of post blocks on home page' => 'Tipo de bloques de publicaciones en la página de inicio',
    'Display post search block' => 'Mostrar bloque de búsqueda de publicaciones',
    'Maximum number of tags displayed on Tags block' => 'Número máximo de etiquetas que se muestran en el bloque de etiquetas',
    'Display tags block' => 'Mostrar bloque de etiquetas',
    'Display categories block' => 'Mostrar bloque de categorías',
    'Search page alias' => 'Buscar alias ​​de la página',
    'Default: "latest"' => 'Predeterminado: "más reciente"',
    'Latest posts page alias' => 'Alias ​​de la página de las últimas publicaciones',
    'Default: "gallery"' => 'Predeterminado: "galería"',
    'Gallery page alias' => 'Alias ​​de la página de la galería',
    'Default: "category"' => 'Predeterminado: "categoría"',
    'Category page alias' => 'Alias ​​de página de categoría',
    'Default: "post"' => '
Predeterminado: "publicación"',
    'Single post page alias' => 'Alias ​​de página de publicación única',
    'Blog meta description' => 'Meta descripción del blog',
    'Separated by a comma (,)' => 'Separado por una coma (,)',
    'Blog meta key words' => 'Metapalabras clave del blog',
    'PRO Blog - All in one package' => 'PRO Blog - Todo en un solo paquete',
    'Blog meta title' => 'Metatítulo del blog',
    'Use URL subfix' => '
Usar subfijo de URL',
    'Default: "blog"' => 'Predeterminado: "blog"',
    'Blog alias' => 'Alias de blog',
    'Enable blog friendly url' => 'Habilitar URL compatible con blogs',
    'Default: F jS Y, Check more at http://php.net/manual/en/function.date.php' => 'Predeterminado: F jS Y, consulte más en http://php.net/manual/en/function.date.php',
    'Slider' => 'Deslizador',
    'Gallery' => 'Galeria',
    'Blog post' => 'Publicación en el blog',
    'PRO Blog - All in one package is the most powerful, flexible Prestashop blog module' => 'Blog PRO: el paquete todo en uno es el módulo de blog de Prestashop más potente y flexible',
    'PRO blog - All in one package' => 'Blog PRO: todo en un solo paquete',
    'Cannot extract zip data' => 'No se pueden extraer los datos zip',
    'Cannot open zip file. It might be broken or damaged' => 'No se puede abrir el archivo zip. Puede estar roto o dañado.',
    'blog-data.xml doesn\'t exist' => '
blog-data.xml no existe',
    'Zip file doesn\'t exist' => 'El archivo zip no existe',
    'Zip file seems to be broken' => 'El archivo zip parece estar roto',
    'Cannot create Menu-Info.xml' => 'No se puede crear Menu-Info.xml',
    'Blog Slider' => 'Control deslizante del blog',
    'Blog search' => 'Búsqueda de blogs',
    'Blog tag' => 'Etiqueta de blog',
    'Home' => 'Inicio',
    'Author: ' => 'Autor',
    'Search:' => 'Buscar',
    'Tag: ' => 'Etiqueta',
    'View blog gallery' => 'Ver galería de blogs',
    'Gallery image saved' => 'Imagen de la galería guardada',
    'The item could not be updated.' => 'No se pudo actualizar el artículo.',
    'The item could not be added.' => 'No se pudo agregar el artículo.',
    'Image is required' => 'La imagen es requerida',
    'Could not create thumbnail. Please try to upload another image.' => 'No se pudo crear la miniatura. Intenta subir otra imagen. ',
    'Comment can not be longer than 2000 characters' => 'El comentario no puede tener más de 2000 caracteres.',
    'Number of latest posts displyed need to be greater than 0' => 'El número de últimas publicaciones mostradas debe ser mayor que 0',
    'Alias need to be unique in ' => 'El alias ​​necesita ser unico',
    'Tag page alias is not valid in ' => 'El alias de la página de etiquetas no es válido en',
    'Tag page alias is not valid in' => 'El alias de la página de etiquetas no es válido',
    'Author page alias is not valid in ' => 'El alias de la página del autor no es válido ',
    'Search page alias is not valid in ' => 'El alias de la página de búsqueda no es válido',
    'Latest posts page alias is not valid in ' => 'El alias de la página de las últimas publicaciones no es válido',
    'Gallery page alias is not valid in ' => 'El alias de la página de galería no es válido
',
    'Category page alias is not valid in ' => 'El alias de la página de categoría no es válido',
    'Single post page alias is not valid in ' => 'El alias de la página de publicación única no es válido',
    'Blog alias is not valid in ' => 'El alias del blog no es válido',
    ...
    'Blog gallery' => 'Galeria del blog',
    'Blog slider' => 'Deslizador del blog',
    ...
    'Manage blog categories' => 'Administrar categorías de blogs',
    'Blog categories' => 'Categorias de Blog',
    'results' => 'Resultados',
    'Showing {start} to {end} of {total} ({pages} Pages)' => 'Mostrando {inicio} a {fin} de {total} ({páginas} páginas)',
    'Yes' => 'Sí',
    'Enabled' => 'Habilitado ',
    'Sort order' => '
Orden de clasificación',
    ...
    'Number of image per page' => 'Número de imagen por página',
    'Slideshow speed' => 'Presentación de diapositivas rápida',
    'Auto play gallery slideshow' => 'Presentación de diapositivas de la galería de reproducción automática
',
    'Light Rounded' => 'Luz redondeada',
    'Light Square' => 'Cuadrado de luz',
    'Dark Rounded' => 'oscuro redondeado',
    'Dark Square' => 'cuadrado oscuro',
    'Maximum number of featured gallery images displayed' => 'Número máximo de imágenes de galería destacadas que se muestran
',
    'Enable gallery carousel slider' => 'Habilitar el control deslizante del carrusel de la galería',
    'Display featured gallery images' => 'Mostrar imágenes destacadas de la galería',
    'Maximum number of feature posts displayed' => 'Número máximo de publicaciones destacadas mostradas',
    'Display featured posts' => 'Mostrar publicaciones destacadas',
    'Maximum number of pupular posts displayed' => 'Número máximo de publicaciones populares mostradas',
    'Display pupular posts block' => 'Mostrar bloque de publicaciones populares',
    'Maximum number of newest posts displayed' => 'Número máximo de publicaciones más recientes mostradas',
    'Display latest news block' => 'Mostrar último bloque de noticias',
    'Carousel slider' => 'Deslizador de carrusel',
    'Type of post blocks in sidebar' => 'Tipo de bloques de publicaciones en la barra lateral
',
    'No sidebar' => 'Sin barra lateral',
    'Right' => 'Derecha',
    'Large box and list' => 'Caja grande y lista',
    'Large box and grid' => '
Caja grande y rejilla',
    'Blog layout' => 'Diseño del blog',
    'Home Page' => 'Página de inicio',
    'Sidebar' => 'Barra lateral',
    'Likes and Comments' => 'Likes y comentarios',
    'Comment' => 'Comentario',
    'ratings' => 'ratings',
    'rating' => 'rating',
    'No ratings' => 'Sin ratings',
    'Manage blog comments' => 'Administrar comentarios del blog',
    'View in post' => 'Ver en la publicación',
    'Not reported' => '
No reportado',
    'Approved' => 'Aprobado',
    'Customer' => '
Cliente',
    ...
    'The comment could not be updated.' => 'No se pudo actualizar el comentario.',
    'Reply can not be longer than 2000 characters' => 'La respuesta no puede tener más de 2000 caracteres',
    'Reply need to be clean HTML' => 'La respuesta debe ser HTML limpio',
    'Views' => 'Vistas',
    'Category' => 'Categoría',
    'Auto detect' => 'Detección automática',
    'Allow comments' => 'Permitir comentarios',
    'Allow guests to like posts' => 'Permitir que los invitados le den like a las publicaciones',
    'Enable post likes' => 'Habilitar Me gusta de la publicación',
    'Enable post image popup' => 'Habilitar ventana emergente de imagen de publicación
',
    'Type of related posts block' => 'Tipo de bloque de publicaciones relacionadas',
    'Number of related posts displayed' => 'Número de publicaciones relacionadas mostradas
',
    'Posts with the same post tags' => 'Publicaciones con las mismas etiquetas de publicación',
    'Display related posts' => '
Mostrar publicaciones relacionadas',
    'Type of related products' => 'Tipos de productos relacionados',
    'Display related products' => 'Mostrar productos relacionados',
    'Thumbnail height (px)' => 'Altura de la miniatura (px)',
    'Receive alert when a comment is reported as abuse' => 'Recibir una alerta cuando un comentario se reporte como abuso',
    'Receive alert when a comment is posted ' => 'Recibir alerta cuando se publique un comentario',
    'Featured posts' => '
Publicaciones destacadas',
    'Latest posts' => 'Ultimas publicaciones',
    'Posts to display on main page' => 'Publicaciones para mostrar en la página principal',
    'Custom color' => 'Color personalizado',
    'List' => 'Lista',
    'Grid' => 'Cuadrícula',
    'Socials' => 'Sociales',
    'View this post' => 'Ver esta publicación',
    'Thumbnail image deleted' => 'Imagen en miniatura eliminada',
    'Date Enabled' => 'Fecha Habilitada',
    'Is featured post' => 'Es una publicación destacada',
    'To add "products" type in product name and choose the product from the dropdown' => 'Para agregar "productos", escriba el nombre del producto y elija el producto del menú desplegable',
    'Related products' => 'Productos relacionados',
    'Choose one or more categories:' => 'Elija una o más categorías:',
    'Recommended size: 260x180' => 'Tamaño recomendado: 260x180',
    'Thumbnail' => 'Miniatura',
    ...
    'Tags' => 'Etiquetas',
    'Only letters and the hyphen (-) character are allowed.' => 'Solo se permiten letras y el carácter de guión (-).',
    ...
    'Emails that you want to receive notifications, separated by a comma (,)' => 'Correos electrónicos de los que desea recibir notificaciones, separados por una coma (,)',
    'Alert emails' => 'Emails de alerta',
    'Valid values: 50 - 1000' => 'Valores válidos: 50 - 1000',
    'Thumbnail width (px)' => 'Ancho de la miniatura (px)',
    'Sidebar position' => 'Posición de la barra lateral',
    'Default: "tag"' => '
Predeterminado: "etiqueta"',
    'Tag page alias' => 'Alias ​​de la página de etiquetas',
    'Default: "author"' => 'Predeterminado: "autor"',
    'Author page alias' => 'Alias ​​de la página del autor',
    'Default: "search"' => 'Predeterminado: Busqueda',
    'Left' => 'Izquierda',
    'lorem,ipsum,dolor' => 'Texto de ejemplo',
  ),
  'ModulesYbcthemeconfigForm' => 
  array (
    'Reset' => 'Reinciar',
    'You are going to reset all parameters to default. Do you confirm?' => 'Vas a restablecer todos los parámetros a los valores predeterminados. ¿Confirmas?',
    'Reset to default parameters' => 'Restablecer a los parámetros predeterminados',
    'Do you want to delete this image?' => '¿Quieres eliminar esta eimágen?',
    'Click to see full size image' => 'Haga clic para ver la imagen a tamaño completo',
    'Uploaded image: ' => 'Imagen cargada:',
    'You are going to overried all sample data. Do you confirm?' => 'Vas a sobrescribir todos los datos de muestra. ¿Confirmas?',
    'You are going to overried your old data of the selected section(s). Do you confirm?' => 'Va a sobrescribir sus datos antiguos de la(s) sección(es) seleccionada(s). ¿Confirmas?',
    'Export sample data to sql files' => 'Exportar datos de muestra a archivos sql',
    'Import sample data' => 'Importar datos de muestra',
    'Clear cache' => 'Limpiar cache',
  ),
  'ModulesYbcthemeconfigYbcthemeconfig' => 
  array (
    'Successfully updated' => 'Actualizado exitosamente',
    'Can not update theme configuration. Please check the errors report above' => 'No se puede actualizar la configuración del tema. Por favor, consulte el informe de errores de arriba',
    'An error occurred during the image upload process.' => 'Ocurrió un error durante el proceso de carga de la imagen.',
    'Can not upload the file' => 'No se puede cargar el archivo',
    ' already exists. Try to rename the file then reupload' => 'ya existe. Intenta cambiar el nombre del archivo y vuelve a subirlo
',
    '"Cache dynamic" CSS can only be enabled if "Display front setting panel" is set to "No"' => 'El CSS "caché dinámico" solo se puede habilitar si "Mostrar panel de configuración frontal" está configurado en "No"',
    'is invalid' => 'Es invalido',
    ' can not be larger than 100Mb' => 'no puede ser mayor a 100Mb',
    'is required' => 'se requieres',
    ' is required' => 'se requiere',
    'Sample data imported' => 'Datos de muestra importados',
    'SQL file does not exist or file access denied (try to set the file CMOD to 755)' => 'El archivo SQL no existe o se denegó el acceso al archivo (intente configurar el archivo CMOD en 755)
',
    'Directory is not writeable. Try to set its CMOD to 755' => 'El directorio no se puede escribir. Intente configurar su CMOD en 755',
    'Choose at least 1 section to import sample data' => 'Elija al menos 1 sección para importar datos de muestra',
    'Website layout has not been set' => 'No se ha configurado el diseño del sitio web',
    'You can not import sample data because "devMode" is enabled' => 'No puede importar datos de muestra porque "devMode" está habilitado',
    'Sample data exported' => 'Datos de muestra exportados',
    'Cache is cleared' => 'El cache está borrado',
    'Yes' => 'Sí ',
    'Google map embed code' => 'Código de inserción del mapa de Google',
    'Contact Info' => 'Información de contacto',
    'Phone number to call' => 'Número de teléfono para llamar',
    'Phone number show' => 'Mostrar número de teléfono',
    'Address' => 'Dirección',
    'Company name' => 'Nombre de la compañia',
    'Setting email: Shop parameters -> Contact' => 'Configuración de correo electrónico: Parámetros de la tienda -> Contacto',
    'Layout 3' => '
Diseño 3',
    'Layout 2' => '
Diseño 2',
    'Contact form layout' => 'Diseño de formulario de contacto',
    ...
    'Your official Vimeo account.' => 'Tu cuenta oficial de Vimeo.',
    'Your official Pinterest account.' => 'Tu cuenta oficial de Pinterest.',
    'Your official Google+ page.' => 'Tu página oficial de Google+.',
    'Thumb vertical left' => '
Pulgar vertical izquierdo',
    'Thumb horizontal' => 'Pulgar horizontal',
    'Product layout' => 'Diseño del producto',
    'Other font data' => 'Otros datos de fuentes',
    'Other font name' => 'Otro nombre de fuente',
    'Heading font data' => 'Encabezado de fuente de datos',
    'Heading font name' => 'Nombre de la fuente del encabezado',
    'General font data' => 'Datos generales de la fuente de datos',
    'Leave blank to use default font' => 'Dejar en blanco para usar la fuente predeterminada',
    'General font name' => 'Nombre de fuente general',
    'Payment logo' => '
logotipo de pago',
    'Copyright text' => 'Texto de derechos de autor',
    'Custom color (Your color)' => 'Color personalizado (Tu color)',
    'Red' => 'Rojo',
    'Blue' => 'Azul',
    'Violet' => 'Violeta',
    'Pink 1' => 'Rosa 1',
    ...
    'Theme color' => 'Color del tema',
    'Layout 1' => 'Diseño 1',
    'Skin is invalid' => 'La skin no es válida',
    'Layout is invalid' => 'El diseño es inválido',
    'Clear / disable cache after importing sample data. This feature will override your old data of the selected section(s) that you will import sample data' => 'Borre/desactive el caché después de importar datos de muestra. Esta función anulará sus datos anteriores de las secciones seleccionadas en las que importará datos de muestra',
    'Html blocks' => 'Bloques Html',
    'Slider' => 'Deslizador',
    'Mega menu' => 'Mega menú',
    'Data to import' => 'Datos a importar',
    '*Note: You need to install and enable module "ybc_productimagehover" to use this feature' => '
*Nota: debe instalar y habilitar el módulo "ybc_productimagehover" para usar esta función',
    'Horizontal Scrolling Right To Left' => 'Desplazamiento horizontal de derecha a izquierda',
    'Horizontal Scrolling Left To Right' => 'Desplazamiento horizontal de izquierda a derecha',
    'Vertical Scrolling Top To Bottom' => 'Desplazamiento vertical de arriba a abajo',
    'Vertical Scrolling  Bottom To Top' => 'Desplazamiento vertical de abajo hacia arriba
',
    'Fade' => 'Desvanecerse',
    'Product image rollover effect' => '
Efecto de rollover de la imagen del producto',
    'Display category description' => 'Mostrar descripción de categoría',
    'Display category image' => 'Mostrar imágen de categoría',
    'Display category name' => 'Mostrar nombre de categoría',
    'Display product review' => 'Mostrar reseña del prodúcto',
    'Enable social sharing buttons' => 'Habilitar botones para compartir en redes sociales',
    'Enable jquery zoom' => '
Habilitar jquery zoom',
    'product image syncing' => 'sincronizacion de imagen de producto',
    'Thumb vertical right' => 'Pulgar vertical derecho',
    'Layout' => 'Diseño',
    '"STORE LOCATOR" Link' => 'Link "LOCALIZADOR DE TIENDAS"',
    'Enable "STORE LOCATOR"' => 'Habilitar "LOCALIZADOR DE TIENDAS"',
    'Float header' => 'Encabezado flotante',
    'Cache dynamic CSS' => 'Caché de CSS dinámico',
    'Display front setting panel' => 'Panel de configuración frontal de la pantalla',
    'Import sample data' => 'Importar datos de muestra',
    'Contact' => 'Contacto',
    'Socials' => 'Sociales',
    'Product listing pages' => 'Páginas de listado de productos',
    'Product details page' => 'Página de detalles del producto',
    'Footer' => 'Pie de página',
    'Header' => 'Encabezado',
    'Fonts' => 'Fuentes',
    'Configure your theme' => 'Configurar tu tema',
    'Display available product quantity' => 'Mostrar la cantidad de productos disponibles',
    'Display product reference text' => 'Mostrar texto de referencia del producto
',
    'Your Facebook fan page.' => 'Tu página de fans en Facebook.',
    'Your official Twitter account.' => 'Tu cuenta oficial de Twitter.',
    'The RSS feed of your choice (your blog, your store, etc.).' => 'El feed RSS de tu elección (tu blog, tu tienda, etc.).',
    'Your official YouTube account.' => 'Tu cuenta oficial de YouTube.',
    'Theme options' => 'Opciones de tema',
    'Configuration is invalid' => 'La configuración no es válida',
    'Background image is only available for BOXED layout' => 'La imagen de fondo solo está disponible para el diseño en CAJA',
...
El fondo no es válido',
  ...
  array (
    ...
    'Awaiting bank wire payment' => 'En espera de  validación de transferencia bancaria',
...
Saludos',
    ...
    'Add new order' => 'Añadir un nuevo pedido',
    'Orders' => 'Pedidos',
    ...
    'Shipping address' => 'Dirección de envío',
    'Invoice address' => 'Dirección para facturación',
    'Account registered:' => 'Cuenta registrada:',
  ...
  array (
    ...
    'Supply Orders' => 'Pedidos de suministro',
    'Supply Order Details' => 'Detalles del pedido de suministro',
    ...
    'Choose the source shop' => 'Escoge la tienda de origen',
    ...
    'Share available quantities between shops of this group. When changing this option, all available products quantities will be reset to 0.' => 'Compartir las cantidades disponibles entre tiendas de este grupo. Al cambiar esta opción, todos las cantidades de productos se restablecerán a 0.',
    ...
    'Supplier reference #' => 'Referencia del proveedor N°',
    'Delivery time of out-of-stock products with allowed orders:' => 'Tiempo de entrega para productos fuera-de-inventario con ordenes permitidas:',
    ...
    'Expiration date (yyyy-mm-dd)' => 'Fecha de Vencimiento (dd-mm-aaaa)',
    ...
    'Lifetime of front office cookies' => 'Tiempo de vida de las cookies del Front Office',
    'Lifetime of back office cookies' => 'Tiempo de vida de las cookies para el Panel de Administración',
    ...
    'Multi-front optimizations' => 'Optimizaciones de Multi-panel frontal',
    ...
    'Check the cookie\'s IP address' => 'Compruebe la dirección IP de las cookies',
    ...
    'megabytes' => 'megabytes',
    'Ignore statistics tables' => 'Ignorar las tablas de estadísticas',
    ...
    'Select a file to import' => 'Seleccione el archivo para importar',
    ...
    'Select your default file encoding' => 'Selecciona la codificación de archivo predeterminada',
  ...
  array (
    '-- Choose --' => '-- Escoge --',
    'or' => 'o',
    'Use this option to associate data (products, modules, etc.) the same way for each selected shop.' => 'Usa esta opción para asociar los datos (productos, módulos, etc.) para cada tienda seleccionada.',
    'Click here to display the shops in the %name% shop group' => 'Haga click aquí para mostrar las tiendas en el grupo de tiendas %name%',
    'Click here to display the URLs of the %name% shop' => 'Haga click aquí para mostrar los enlaces de la tienda %name%',
    'Click here to display the list of shop groups' => 'Haz clic aquí para mostrar el listado de grupos de tiendas',
    'Warning: Enabling the "share customers" and "share orders" options is not recommended. Once activated and orders are created, you will not be able to disable these options. If you need these options, we recommend using several categories rather than several shops.' => 'Advertencia: No se recomienda habilitar las opciones "compartir clientes" y "compartir pedidos". Una vez activas y con pedidos creados, ya no se podrán deshabilitar. Si necesitas esta opciones, te recomendamos usar varias categorías en lugar de varias tiendas.',
    'Once this option is enabled, the shops in this group will share customers. If a customer registers in any one of these shops, the account will automatically be available in the others shops of this group.' => 'Una vez esta opción es habilitada, las tiendas de este grupo compartirán clientes. Si un cliente se registra en cualquiera de estas tiendas, la cuenta estará disponible automáticamente en otras tiendas de este grupo.',
    'Warning: you will not be able to disable this option once you have registered customers.' => 'Advertencia: No podrás deshabilitar esta opción una vez hayas registrado clientes.',
    'Once this option is enabled (which is only possible if customers and available quantities are shared among shops), the customer\'s cart will be shared by all shops in this group. This way, any purchase started in one shop will be able to be completed in another shop from the same group.' => 'Una vez esta opción es habilitada (lo que solamente es posible si los clientes y las cantidades disponibles son compartidas entre las tiendas), el carrito será compartido por todas las tiendas de este grupo. De esta manera, cualquier compra iniciada en una tienda estará disponible para ser completada en otra tienda del mismo grupo.',
    'Warning: You will not be able to disable this option once you\'ve started to accept orders.' => 'Advertencia: No podrás deshabilitar esta opción una vez hayas comenzado a aceptar pedidos.',
    ...
    'URL rewriting must be activated on your server to use this feature.' => 'La reescritura de enlaces debe ser activada en el servidor para usar esta característica.',
    ...
    'Warning: URL rewriting (e.g. mod_rewrite for Apache) seems to be disabled. If your Virtual URL doesn\'t work, please check with your hosting provider on how to activate URL rewriting.' => 'Advertencia: La reescritura URL (ej: mod_rewrite para Apache) parece estar deshabilitada. Si tu URL virtual no funciona, por favor, consulta con tu proveedor de alojamiento web pasa saber cómo activar la reescritura URL.',
    ...
    'New modules and updates are displayed on the modules page.' => 'Los nuevos módulos y actualizaciones se muestran en la página de módulos.',
    'Check the IP address of the cookie in order to prevent your cookie from being stolen.' => 'Compruebe la dirección IP de la cookie para evitar que su cookie sea robada.',
    'Set the amount of hours during which the front office cookies are valid. After that amount of time, the customer will have to log in again.' => 'Establezca la cantidad de horas durante las cuales los cookies de front office son válidas. Después de ese tiempo, el cliente tendrá que iniciar sesión de nuevo.',
...
',
    'Define the upload limit for a downloadable product (in megabytes). This value has to be lower or equal to the maximum file upload allotted by your server (currently: %size% MB).' => 'Defina el tamaño límite para un producto descargable subido (en megabytes). Este valor debe ser menor o igual al máximo de subida de archivos asignado por su servidor (actualmente: %size% MB).',
    'Define the upload limit for an image (in megabytes). This value has to be lower or equal to the maximum file upload allotted by your server (currently: %size% MB).' => 'Defina el tamaño límite para una imagen subida (en megabytes). Este valor debe ser menor o igual al valor máximo de subida de archivos asignado por su servidor (actualmente: %size% MB).',
    ...
    'How to restore a database backup in 10 easy steps' => 'Cómo restaurar una copia de seguridad en 10 simples pasos',
    ...
    'Unless you enabled the "Drop existing tables" option, you must delete all tables from your current database.' => 'Al menos que hayas habilitado la opción "Eliminar tablas existentes", debes eliminar todas las tablas de tu base de datos actual.',
    ...
    'You can read information on import at:' => 'Puedes leer información sobre como importar en:',
    ...
    'Allow or disallow this employee to log in to the Admin panel.' => 'Permitir o prohibir a este empleado iniciar sesión en el panel de Administrador.',
    ...
    'Set the amount of hours during which the back office cookies are valid. After that amount of time, the PrestaShop user will have to log in again.' => 'Indique las horas de validez de las cookies del panel de administración. Después de ese tiempo, el usuario PrestaShop tendrá que volver a iniciar sesión.',
    'Set the maximum size allowed for attachment files (in megabytes). This value has to be lower or equal to the maximum file upload allotted by your server (currently: %size% MB).' => 'Establecer el tamaño máximo permitido para archivos adjuntos (en megabytes). Este valor debe ser menor o igual al valor máximo de subida de archivos asignado por su servidor (actualmente: %size% MB).',
    ...
    'This will display notifications every time a new customer registers in your shop.' => 'Esto mostrará notificaciones cada vez que un cliente nuevo se registre en su tienda.',
    'This will display notifications when new messages are posted in your shop.' => 'Esto mostrará notificaciones cuando mensajes nuevos sean publicados en su tienda.',
    ...
    'CCC allows you to reduce the loading time of your page. With these settings you will gain performance without even touching the code of your theme. Make sure, however, that your theme is compatible with PrestaShop 1.4+. Otherwise, CCC will cause problems.' => 'Las herramientas CCC reducen el tiempo de carga de tus páginas. Con estos parámetros mejorarás el rendimiento sin necesidad de tocar o modificar el código de tu tema. Sin embargo, asegúrate que tu tema es compatible con la versión I. 4 o posterior de PrestaShop, de lo contrario, CCC causará problemas.',
...
',
  ...
  array (
    'You do not have permission to view this.' => 'No tienes permiso para ver este contenido.',
    'There is no "/backup" directory.' => 'No hay ningún directorio "/backup".',
    'No file has been specified.' => 'No ha sido especificado ningún archivo.',
    ...
    'Aborting, please wait...' => 'Anulando Acción. Por favor, espere...',
    ...
    'The password must be at least %length% characters long.' => 'La contraseña debe tener una longitud de al menos %length% caracteres.',
    ...
    'EAN13 "%ean13%" has incorrect value for product with id %id%.' => 'El código EAN13 "%ean13%" posee un valor erróneo para el producto con identificador id %id%.',
    'Advanced stock management has incorrect value. Not set for product with id %id%.' => 'La administración avanzada de inventario posee un valor erróneo. No establecido para el producto de identificador id %id%.',
    'Advanced stock management is not enabled, cannot enable on product with id %id%.' => 'La administración avanzada de inventario no está habilitada, imposible habilitar en producto de identificador id %id%.',
    'Advanced stock management is not enabled, warehouse is not set on product with id %id%.' => 'La administración avanzada de inventario no está habilitada, almacén no establecido en el producto de identificador id %id%.',
    'Warehouse did not exist, cannot set on product %name%.' => 'Almacén inexistente, imposible establecer en producto %name%.',
    ...
    '%1$s does not exist in database %2$s (ID: %3$s), and therefore cannot be saved' => '%1$s no existe en la base de datos %2$s (ID: %3$s) y, por tanto, no puede guardarse',
    ...
    'Supplier ID (%id%) is not valid (at line %line%).' => 'El identificador ID de proveedor (%id%) no es válido (en la línea %line%).',
    'Lang ID (%id%) is not valid (at line %line%).' => 'El identificador ID de idioma (%id%) no es válido (en la línea %line%).',
    'Warehouse ID (%id%) is not valid (at line %line%).' => 'El identificador ID de almacén (%id%) no es válido (en la línea %line%).',
    'Currency ID (%id%) is not valid (at line %line%).' => 'El identificador ID de moneda (%id%) no es válido (en la línea %line%).',
    'Reference (%ref%) already exists (at line %line%).' => 'La referencia (%ref%) ya existe (en la línea %line%).',
    'YYYY-MM-DD' => 'AAAA-MM-DD',
    'Date format (%date%) is not valid (at line %line%). It should be: %date_format%.' => 'El formato de fecha (%date%) no es válido (en la línea %line%). Debería ser: %date_format%.',
    'Date (%date%) cannot be in the past (at line %line%). Format: %date_format%.' => 'La fecha (%date%) no puede estar ubicada en el pasado (en la línea %line%). Formato: %date_format%.',
    'Format: Between 0 and 100' => 'Formato: entre 0 y 100',
    'Discount rate (%rate%) is not valid (at line %line%). %format%.' => 'La tasa de descuento (%rate%) no es válida (en la línea %line%). %format%.',
    'Supply Order (%id%) is not editable (at line %line%).' => 'La Orden de Compra (%id%) no es modificable (en la línea %line%).',
    'Supply Order could not be saved (at line %line%).' => 'No es ha logrado guardar la Orden de Compra (en la línea %line%).',
    ...
    '%category_name% (ID: %id%) cannot be saved' => 'No se puede guardar %category_name% (Identificador ID: %id%)',
    'URL rewriting failed to auto-generate a friendly URL for: %category_name%' => 'La reescritura de enlaces ha fallado al intentar generar automáticamente un enlace amigable para: %category_name%',
    ...
    'Advanced stock management has incorrect value. Not set for product %name%' => 'La administración avanzada de inventario posee un valor erroneo. No establecido para el producto %name%',
    'Advanced stock management is not enabled, cannot enable on product %name%' => 'La administración avanzada de inventario no está habilitada, imposible habilitar en producto %name%',
    'Advanced stock management is not enabled, warehouse not set on product %name%' => 'La administración avanzada de inventario no está habilitada, almacén no establecido en el producto %name%',
    'Incorrect value for "Depends on stock" for product %name%' => 'Valor incorrecto para "Dependiendo del stock" para el producto %name%',
    'Advanced stock management is not enabled, cannot set "Depends on stock" for product %name%' => 'La administración avanzada de inventarios no está habilitada, imposible establecer "Dependiendo del stock" para el producto %name%',
    'Warehouse did not exist, cannot set on product %name%' => 'El almacén no existe, no se puede establecer en el producto %name%',
    ...
    'The "*" operator cannot be used in a nested query.' => 'El operador "*" no se puede usar en un una consulta anidada.',
    ...
    'You should back up your data on a regular basis (both files and database).' => 'Deberías respaldar tus datos en una copia de seguridad de manera regular (tanto de los archivos como de la base de datos).',
    ...
    'By default, your existing database tables will be dropped during the backup recovery (see "Backup options" below).' => 'De manera predeterminada, las tablas de la base de datos existentes se eliminarán durante la restauración de la copia de seguridad (consultar "Opciones de copia de seguridad").',
    ...
    'Do you really want to remove the server %serverIp%:%serverPort% ?' => '¿Realmente desea remover el servidor %serverIp%:%serverPort%?',
    'OK' => 'OK',
  ...
  array (
    ...
    'Save then add another value' => 'Guardar y luego añadir otro valor',
    ...
    'Disabled Categories' => 'Categorías inhabilitadas',
    ...
    'Add new root category' => 'Añadir una nueva categoría de raíz',
    ...
    'Bulk actions ([1]/[2] combination(s) selected)' => 'Acciones masivas ([1]/[2] combinacion(es) seleccionada(s))',
    ...
    'Zoom' => 'Zoom',
    'Add new value' => 'Añadir un nuevo valor',
    ...
    'Add new attribute' => 'Añadir un nuevo atributo',
    ...
    'Bulk edit quantity' => 'Editar cantidad en masa',
  ...
  array (
    ...
    'Upload an image file containing the color texture from your computer.' => 'Subir un archivo de imagen que contenga la textura de color desde tu computadora.',
    'This will override the HTML color!' => '¡Esto anulará el color HTML!',
    'Save then add another value' => 'Guardar y luego añadir otro valor',
    ...
    'Phone number for this supplier' => 'Número telefónico de este proveedor',
    ...
    'Enable or disable the product on your shop: ALT+SHIFT+O' => 'Activar o desactivar el producto en tu tienda: ALT+SHIFT+O',
    'Save the product and stay on the current page: ALT+SHIFT+S' => 'Guardar el prodcuto y permanecer en la página actual: ALT+SHIFT+S',
    ...
    'Display delivery time for a product is advised for merchants selling in Europe to comply with the local laws.' => 'La muestra de plazo de entrega es recomendada para comerciantes vendiendo en Europa con el fin de cumplir con las leyes locales.',
    'edit' => 'Modificar',
    ...
    'The email will be sent to all the users who have the right to run the stock page. To modify the permissions, go to [1]Advanced Parameters > Team[/1]' => 'El correo electrónico será enviado a todos los usuarios con permiso para trabajar en la página de inventarios. Para modificar los permisos, ir a [1]Parámetros Avanzados > Equipo[/1]',
    ...
    'Not all shops sell new products. This option enables you to indicate the condition of the product. It can be required on some marketplaces.' => 'No todas las tiendas venden productos nuevos. Esta opción te permite indicar el estado del producto. Puede ser necesario en algunos lugares de mercado.',
    ...
    'This is the main image for your category, displayed in the category page. The category description will overlap this image and appear in its top-left corner.' => 'Esta es la imagen principal de tu categoría, mostrada en la página de categorías. La descripción será superpuesta por esta imagen y aparecerá en la esquina superior izquierda.',
    'Displays a small image in the parent category\'s page, if the theme allows it.' => 'Muestra una imagen pequeña en la página de la categoría principal, si el tema lo permite.',
  ...
  array (
    ...
    'The discount was successfully generated.' => 'El descuento ha sido generado exitosamente.',
    ...
    'The file %file% exceeds the size allowed by the server. The limit is set to %size% MB.' => 'El archivo %file% sobrepasa el tamaño permitido por el servidor. El límite está ajustado como %size% MB.',
    ...
    'This feature has been disabled. You can activate it here: %link%.' => 'Esta característica ha sido inhabilitada. Puede volver a activarla aquí: %link%.',
    ...
    'Invalid voucher.' => 'Cupón de descuento inválido.',
    'The category cannot be moved here.' => 'La categoría no puede ser movida aquí.',
    'The category cannot be a parent of itself.' => 'La categoría no puede ser una categoría principal de si misma.',
    'Unknown delete mode: %s' => 'Modo de eliminación desconocido: %s',
    'An error occurred while uploading category image.' => 'Ocurrió un error al subir la imagen de la categoría.',
    'An error occurred while uploading thumbnail image.' => 'Ocurrió un error al subir la miniatura de la imagen.',
    ...
    'Please select a discount type (amount or percentage).' => 'Por favor, selecciona un tipo de descuento (por cantidad o porcentaje).',
    ...
    'Product(s) successfully duplicated.' => 'Productos(s) duplicado(s) correctamente.',
    ...
    'You cannot remove this category because one of your shops uses it as a root category.' => 'No puedes remover esta categoría porque una de tus tiendas la está usando como categoría raíz.',
    'An error occurred while uploading the image:' => 'Se ha producido un error al subir la imagen:',
    ...
    'There is no result for this search. Update your filters to view other products.' => 'No hay resultados para esta búsqueda. Actualiza tus filtros para ver otros productos.',
    ...
    'Deletion failed.' => 'Eliminación fallida.',
    ...
    'Deleting products' => 'Eliminando porductos',
    'Deleting...' => 'Eliminando...',
    ...
    'You have reached the limit (%s) of files to upload, please remove files to continue uploading' => 'Has alcanzado el límite (%s) de archivos para subir, por favor, elimina archivos para continuar subiendo',
    'This feature has been disabled. You can activate it here: %url%.' => 'Se ha desactivado esta característica. Puede volver a activarla aquí: %url%.',
  ...
  array (
    ...
    'Display non-positionable hooks' => 'Mostrar ganchos invisibles',
    'Unhook' => 'Desenganchar',
    ...
    'Maximum file size of product customization pictures' => 'Tamaño máximo de archivo para las imágenes de personalización del producto',
    'bytes' => 'bytes',
    ...
    'Use the legacy image filesystem' => 'Usar el sistema de archivos de imágenes heredado',
    'Image type' => 'Tipo de imagen',
    'Name for the image type' => 'Nombre para el tipo de imagen',
    'Add new image type' => 'Añadir nuevo tipo de imágen',
    ...
    'Favicons' => 'Favicons',
    'Select a theme for the "%name%" shop' => 'Seleccionar un tema para la tienda "%name%"',
    ...
    'Adaptation to Right-to-Left languages' => 'Adecuación para lenguajes leídos de derecha a izquierda',
  ...
  array (
    ...
    'To add "tags" click in the field, write something, and then press "Enter."' => 'Para agregar "etiquetas", haga clic en el campo, escriba algo, y luego presione "Enter"',
    'JPEG images have a small file size and standard quality. PNG images have a larger file size, a higher quality and support transparency. Note that in all cases the image files will have the .jpg extension.' => 'Las imágenes JPEG tienen un tamaño pequeño y una calidad estándar. Las imágenes PNG tienen un tamaño y calidad mayor e incluyen soporte de transparencia. Ten en cuenta que en todos los casos los archivos de imágenes tendrán la extensión .jpg.',
    'WARNING: This feature may not be compatible with your theme, or with some of your modules. In particular, PNG mode is not compatible with the Watermark module. If you encounter any issues, turn it off by selecting "Use JPEG".' => 'ADVERTENCIA: Esta característica tal vez no sea compatible con tu tema, o con alguno de tus módulos. Particularmente, el modo PNG no es compatible con módulo Marca de Agua. Si tienes algún problema, desactiva la opción seleccionando "Usar JPEG".',
    'Ranges from 0 (worst quality, smallest file) to 100 (best quality, biggest file).' => 'El rango de comprensión va desde 0 (peor calidad, archivo más pequeño) hasta 100 (mejor calidad, archivo más grande).',
    ...
    'The maximum file size of pictures that customers can upload to customize a product (in bytes).' => 'El tamaño máximo de archivo de las imágenes que los clientes pueden subir para personalizar un producto (en bytes).',
    ...
    'Warning: you can use a PNG file for transparency, but it can take up to 1 second per page for processing. Please consider using JPG instead.' => 'Advertencia: Puedes usar un archivo en formato PNG para transparencias, pero este puede tomar hasta 1 segundo por página para ser procesado. Por favor, considera la opción de usar JPG en su lugar.',
    ...
    'Be careful! Please check your theme in an RTL language before generating the RTL stylesheet: your theme could be already adapted to RTL.\\nOnce you click on "Adapt to RTL", any RTL-specific file that you might have added to your theme might be deleted by the created stylesheet.' => '¡Tenga cuidado! Por favor revise su tema en un lenguaje RTL antes de generar la hoja de estilo RLT: su tema podría ya estar adaptado a RTL.\\nUna vez haga click en "Adaptar a RTL", cualquier archivo específico para RTL que dentro de su tema puede ser borrado por la hoja de estilo creada.',
...
Una vez actives la opción "%generate_rtl_label%", cualquier archivo específico RTL que hayas añadido al tema podría ser eliminado por la hoja de estilo creada.',
  ...
  array (
    ...
    'After moving all of your product images, set the "Use the legacy image filesystem" option above to "No" for best performance.' => 'Después de mover todas sus imágenes de productos, ajuste la opción "Usar el sistema de archivos de imágenes heredado" como "No" para maximizar el rendimiento.',
    ...
    'Duplicate images were found when moving the product images. This is likely caused by unused demonstration images. Please make sure that the folder %folder% only contains demonstration images, and then delete it.' => 'Se han encontrado imágenes duplicadas al mover las imágenes de productos. Esto probablemente se atribuya a imágenes de demostración sin usar. Por favor asegúrese de que la carpeta %folder% contiene solo imágenes de demostración y luego elimínela.',
    ...
    'Not all images have been moved. The server timed out before finishing. Click on "Move images" again to resume the moving process.' => 'No se han movido todas las imágenes. El tiempo de conexión del servidor se agotó antes de terminar. Haz clic de nuevo en "Mover imágenes" para reanudar el proceso.',
    ...
    'Your RTL stylesheets has been generated successfully' => 'Sus hojas de estilo RTL han sido generadas exitosamente',
  ...
  array (
    ...
    'Contains states' => 'Contiene estados',
    'Do you need a tax identification number?' => '¿Necesita un número de identificación fiscal?',
    'Display tax label (e.g. "Tax incl.")' => 'Mostrar la etiqueta de impuestos (por ejemplo, "Iva incl.")',
    'Does it need Zip/Postal code?' => '¿Necesita código postal/Zip?',
    ...
    'Live exchange Rate for %shop_name%' => 'Tasa de cambio a tiempo real para %shop_name%',
    ...
    'Installed modules translations' => 'Traducciones de los módulos instaladas',
  ...
  array (
    ...
    'Display this country to your customers (the selected country will always be displayed in the Back Office).' => 'Mostrar este país a sus clientes (el país siempre será visible en el panel de administración).',
    ...
    'Country where the state is located.' => 'País donde está ubicado el estado.',
    'Only the countries with the option "contains states" enabled are displayed.' => 'Sólo se muestra los países con la opción "contiene estados" habilitada.',
    ...
    'Short date format (e.g., Y-m-d).' => 'Formato de fecha corto (por ejemplo: A-m-d).',
    'Full date format (e.g., Y-m-d H:i:s).' => 'Formato de fecha completo (por ejemplo: A-m-d H:m:s).',
  ...
  array (
    ...
    'After creating the language, you can import the content of the language pack, which you can download under "International -- Translations."' => 'Después de crear el lenguaje, usted puede importar el contenido del paquete de lenguaje, el cual puede descargar a través de "Internacional -- Traducciones".',
    ...
    'Invalid Zone name.' => 'Nombre de zona inválido.',
    'Invalid state properties.' => 'Propiedades de estado inválidas.',
    'Cannot update the associated country: %s' => 'No se puede actualizar el país asociado: %s',
    'An error occurred while adding the state.' => 'Ha ocurrido un error al añadir el estado.',
    'An error occurred while fetching the state.' => 'Ocurrió un error al recuperar el estado.',
    'Invalid tax properties.' => 'Propiedades de impuesto inválidas.',
    'An error occurred while importing the tax: %s' => 'Se ha producido un error al importar el impuesto: %s',
    'This tax rule cannot be saved.' => 'Esta regla de impuestos no puede ser guardada.',
    'Invalid currency properties.' => 'Propiedades de moneda inválidas.',
    ...
    'An error occurred while setting the units.' => 'Ocurrió un error al configurar las unidades.',
    ...
    'An error occurred during the default group update' => 'Ocurrió un error al actualizar el grupo predeterminado',
    'An error has occurred during the default group update' => 'Ocurrió un error al actualizar el grupo predeterminado',
    'Invalid language ISO code (%s)' => 'Código ISO del idioma no valido (%s)',
    'The translation was added successfully, but the language has not been created.' => 'La traducción fue añadida exitosamente, pero el idioma no fue creado.',
    ...
    'No tax' => 'No hay impuesto',
    'This ISO code already exists.You cannot create two countries with the same ISO code.' => 'Este código ISO ya existe. No puedes crear dos países con el mismo código ISO.',
    'Invalid address layout %s' => 'Formato de dirección no válido %s',
    'The currency conversion rate cannot be equal to 0.' => 'La tasa de conversión de la moneda no puede ser igual a 0.',
    'When you delete a language, all related translations in the database will be deleted. Are you sure you want to proceed?' => 'Cuando eliminas un idioma, todas las traducciones relacionadas serán eliminadas también de la base de datos. ¿Estás seguro que deseas proceder?',
    'Flag and "No picture" image fields are required.' => 'Se requieren los campos de imagen de bandera y "Sin imagen".',
    'An error occurred while resizing "No picture" image to your product directory.' => 'Ocurrió un error al redimensionar la imagen "Sin imagen" en el directorio de productos.',
    'An error occurred while resizing "No picture" image to your category directory.' => 'Ocurrió un error al redomensionar la imagen "Sin imagen" en el directorio de categorías.',
    ...
    'An error occurred during image deletion process.' => 'Ocurrió un durante el proceso de eliminación de la imagen.',
    'Iso code is not valid' => 'Código ISO no válido',
    'Technical Error: ps_version is not valid' => 'Error técnico: ps_version no es válida',
    'Wrong ISO code, or the selected language pack is unavailable.' => 'Código ISO erróneo o el paquete de idioma seleccionado no está disponible.',
    'Technical Error: translation server unreachable.' => 'Error técnico: servidor de traducción inaccesible.',
    'This ISO code already exists. You cannot create two states with the same ISO code.' => 'Este código ISO ya existe. No puedes crear dos estados con el mismo código ISO.',
    'This state was used in at least one address. It cannot be removed.' => 'Este estado fue usado en al menos una dirección. No se puede eliminar.',
    ...
    'The Zip/postal code is invalid. It must be typed as follows: %format% for %country%.' => 'El código postal no es válido. Este debe ser escrito de la siguiente manera: %format% para %country%.',
    'An error has occurred: Cannot save the current tax rule.' => 'Ocurrió un error: No se puede guardar la regla de impuestos actual.',
    ...
    'Impossible to create the directory "%folder%".' => 'Imposible crear el directorio "%folder%".',
    'An error occurred while creating archive.' => 'Ocurrió un error al crear el archivo.',
    ...
    'Validation failed for: %file%' => 'Ha fallado la validación para: %file%',
    'Unidentified file found: %file%' => 'Se ha encontrado un archivo sin identificar: %file%',
    'The archive cannot be extracted.' => 'El archivo no puede ser extraído.',
    'ISO CODE invalid "%iso_code%" for the following file: "%file%"' => 'CÓDIGO ISO inválido "%iso_code%" para el archivo: "%file%"',
    'Cannot write to the theme\'s language file (%s). Please check writing permissions.' => 'No se puede escribir en el archivo de idioma del tema (%s). Por favor, consulta los permisos de escritura.',
    ...
    'Invalid module name "%module%"' => 'Nombre de módulo "%module%" inválido',
    'Invalid mail name "%mail%"' => 'Nombre de correo "%mail%" inválido',
    ...
    'Empty string found, please edit: "%file%"' => 'Se ha encontrado una cadena vacía, por favor edite: "%file%"',
    'There is an error in template, an empty string has been found. Please edit: "%file%"' => 'Hay un error en la plantilla: se ha encontrado una cadena vacía. Por favor edite: "%file%"',
    'The module directory must be writable.' => 'El directorio de módulos debe tener permisos de escritura.',
    'A mail directory exists for the "%iso_code%" language, but not for the default language (%language%) in %folder%' => 'Existe un directorio de correo para el lenguaje "%iso_code%", pero no para el lenguaje predeterminado (%language%) en %folder%',
    'missing translation(s)' => 'traducción(es) faltantes',
    'No Subject was found for %mail_name% in the database.' => 'No se ha encontrado un Asunto para %mail_name% en la base de datos.',
    'There was a problem getting the mail files.' => 'Se ha producido un error inesperado al obtener los archivos de e-mail.',
    'English language files must exist in %folder% folder' => 'Deben existir archivos para el lenguaje inglés en la carpeta %folder%',
    'Cannot write language file for email subjects. Path is: %folder%' => 'Imposible escribir el archivo de lenguaje para los asuntos de correo electrónico. La ruta es: %folder%',
    'Cannot write into the "%file%"' => 'Imposible escribir sobre "%file%"',
    ...
    'Cannot create the folder "%folder%". Please check your directory writing permissions.' => 'Imposible crear la carpeta "%folder%". Por favor revise sus permisos de escritura sobre el directorio.',
    ...
    'Impossible to copy "%source%" to "%dest%".' => 'Imposible copiar de "%source%" a "%dest%".',
    ...
    'Fatal error: ISO code is not correct' => 'Error fatal: el código ISO es incorrecto',
    ...
    'You cannot delete the language currently in use. Please select a different language.' => 'No puedes eliminar el idioma que actualmente está en uso. Por favor, selecciona uno diferente.',
    'You cannot change the status of the default language.' => 'No puedes cambiar el estatus del idioma predeterminado.',
    'This ISO code is already linked to another language.' => 'Este código ISO ya está vinculado a otro idioma.',
    'An error occurred while copying "No Picture" image to your product folder.' => 'Ocurrió un error al copiar la imagen "Sin imagen" en la carpeta del producto.',
    'An error occurred while copying "No picture" image to your category folder.' => 'Ocurrió un error al copiar la imagen "Sin imagen" en la carpeta de categorías.',
    ...
    'The translations have been successfully added.' => 'Las traducciones han sido añadidas exitosamente.',
    'The translation was successfully copied.' => 'La traducción ha sido copiada exitosamente.',
    ...
    'Country selection is invalid.' => 'La selección del país es inválida.',
    ...
    'When you delete a language, all related translations in the database will be deleted.' => 'Cuando eliminas un idioma, todas las traducciones relacionadas serán eliminadas también de la base de datos.',
  ...
  array (
    ...
    'You can reset your password every %interval% minute(s) only. Please try again later.' => 'Solo puede restablecer su contraseña cada %interval% minuto(s). Por favor intente de nuevo más tarde.',
    ...
    'An error occurred while attempting to change your password.' => 'Ocurrió un error intentando cambiar tu contraseña.',
  ...
  array (
    ...
    'Connect to Addons marketplace' => 'Conectarse al mercado de Complementos',
    ...
    'Module verification' => 'Verificación de módulo',
    'Author' => 'Autor',
  ...
  array (
    ...
    'The module was successfully downloaded.' => 'El módulo ha sido descargado exitosamente.',
    'Module(s) installed successfully.' => 'Módulo(s) instalado(s) exitosamente.',
    'Module(s) uninstalled successfully.' => 'Módulo(s) desinstalado(s) exitosamente.',
    'Module reset successfully.' => 'Módulo reiniciado exitosamente.',
    'Module deleted successfully.' => 'Módulo eliminado exitosamente.',
    ...
    'Upgraded from: %s to %s' => 'Actualizado desde:%s hasta %s',
    ...
    'An error occurred while copying the archive to the module directory.' => 'Ocurrió un error al copiar el archivo al directorio del módulo.',
    ...
    'The module was successfully removed from the hook.' => 'El módulo fue removido del hook exitosamente.',
    'The module transplanted successfully to the hook.' => 'El módulo fue copiado al hook exitosamente.',
...
' => 'https://www.prestashop.com/es/recursos/documentacion?utm_source=back-office&utm_medium=profile&utm_campaign=resources-en&utm_content=download17',
  ...
  array (
    ...
    'Shopping Carts' => 'Carrito de compra',
    'Shops' => 'Tiendas',
    'States' => 'Provincias',
    'Stats' => 'Estadísticas',
    ...
    'Categories' => 'Categorías',
    'Contacts' => 'Contacto',
    'Credit Slips' => 'Factura por abono',
    'Currencies' => 'Monedas',
    ...
    'Order Messages' => 'Mensaje del pedido',
    'Delivery Slips' => 'Albarán de entrega',
    'Translations' => 'Traducciones',
    'Webservice' => 'Webservice',
    'Statuses' => 'Estados del pedido',
  ...
  array (
    ...
    'How about some seasonal discounts?' => '¿Que tal si incluye algunos descuentos de temporada?',
  ...
  array (
    ...
    'Address format invalid' => 'Formato de dirección inválido',
    ...
    'A shop URL that uses this domain already exists.' => 'Ya existe una URL de tienda que usa este dominio.',
...
',
  ...
  array (
    ...
    'Delete selected' => 'Eliminar seleccionados',
    'Delete selected items?' => '¿Eliminar los elementos seleccionados?',
    'Delete selected item?' => '¿Eliminar el artículo seleccionado?',
  ...
  array (
    ...
    'The thumbnails were successfully regenerated.' => 'Las miniaturas fueron regeneradas exitosamente.',
    'Successful upload.' => 'Subido satisfactoriamente.',
    'Duplication was completed successfully.' => 'La duplicación se completó exitosamente.',
    'The selected images have successfully been moved.' => 'Las imágenes seleccionadas ha sido movidas exitosamente.',
    ...
    'A zone has been assigned to the selection successfully.' => 'Se ha asignado exitosamente una zona a la selección.',
    'Successful upgrade.' => 'Actualización correcta.',
    'The status has been updated successfully' => 'El estado se ha actualizado con éxito',
    'Failed to update the status' => 'Fallo al actualizar el estado',
    'The status has been updated successfully.' => 'El estatus ha sido actualizado exitosamente.',
    'Settings updated' => 'Configuración actualizada',
    ...
    'Your theme has been correctly exported: %path%' => 'Tu tema se ha exportado correctamente: %path%',
    'The settings have been successfully updated.' => 'La configuración ha sido actualizada exitosamente.',
    'Successful creation.' => 'Creación correcta.',
    'Successful deletion.' => 'Eliminación correcta.',
    'The status has been successfully updated.' => 'El estatus ha sido actualizado exitosamente.',
    ...
    'The image was successfully deleted.' => 'La imagen ha sido borrada exitosamente.',
    'Update successful.' => 'Actualización correcta.',
  ...
  array (
    ...
    'The message was successfully sent to the customer.' => 'El mensaje ha sido enviado exitosamente al cliente.',
    ...
    'A partial refund was successfully created.' => 'Reembolso parcial creado exitosamente.',
    'You have to select a shop before creating new orders.' => 'Tienes que seleccionar una tienda antes de crear más pedidos.',
  ...
  array (
    ...
    'Shipping locations and costs' => 'Ubicaciones de envío y costos',
    ...
    'According to total price' => 'Acorde al precio total',
    'According to total weight' => 'Acorde al peso total',
  ...
  array (
    ...
    'Mark the groups that are allowed access to this carrier.' => 'Marque todos los grupos que pueden tener acceso a este transportista.',
    'Enable the carrier in the front office.' => 'Habilitar al transportista en el Front Office.',
    'Carrier name displayed during checkout' => 'Nombre del transportista que aparece durante el proceso de compra',
    'Upload a logo from your computer.' => 'Subir un logo de su computadora.',
    'or' => 'o',
    'Estimated delivery time will be displayed during checkout.' => 'El tiempo estimado para la entrega del producto será mostrado durante la compra.',
    'Delivery tracking URL: Type \'@\' where the tracking number should appear. It will then be automatically replaced by the tracking number.' => 'Enlace de seguimiento de entrega. Introduzca \'@\' donde el número de seguimiento debe aparecer. Este símbolo será sustituido automáticamente por éste número.',
    'The zones in which this carrier will be used.' => 'Zonas para las que aplica este transportista.',
    'Group access' => 'Acceso de grupo',
    'Apply both regular shipping cost and product-specific shipping costs.' => 'Aplicar gastos de envío y costes adicionales específicos por producto.',
    ...
    'Apply the cost of the highest defined range' => 'Aplicar el coste más alto del rango definido',
    'Out-of-range behavior occurs when none is defined (e.g. when a customer\'s cart weight is greater than the highest range limit).' => 'El comportamiento fuera de rango se produce cuando ninguno está definido. (ej. cuando el peso de un carrito de un cliente es mayor al limite del rango más alto).',
    'Maximum height managed by this carrier. Set the value to "0," or leave this field blank to ignore.' => 'Altura máxima permitida por este transportista. Establece el valor a "0" o deja este campo vacío para ignorarlo.',
    'Maximum width managed by this carrier. Set the value to "0," or leave this field blank to ignore.' => 'Anchura máxima permitida por este transportista. Establece el valor a "0" o deja este campo vacío para ignorarlo.',
    'Maximum depth managed by this carrier. Set the value to "0," or leave this field blank to ignore.' => 'Profundidad máxima permitida por este transportista. Establece el valor a "0
" o deja este campo vacío para ignorarlo.',
    'Maximum weight managed by this carrier. Set the value to "0," or leave this field blank to ignore.' => 'Peso máximo permitido por este transportista. Establece el valor a "0
" o deja este campo vacío para ignorarlo.',
  ...
  array (
    ...
    'An error occurred while saving carrier groups.' => 'Ha ocurrido un error mientras se guardaban los grupos de transportistas.',
    'An error occurred while saving carrier zones.' => 'Ha ocurrido un error mientras que se guardaban las zonas del transportista.',
    'An error occurred while saving carrier ranges.' => 'Ha ocurrido un error mientras se guardaba el rango del transportista.',
...
Gracias por su paciencia.',
    ...
    'If your server stops before the process ends, you can resume the indexing by clicking "Add missing products to the index".' => 'Si tu servidor se detiene antes de terminar el proceso, puedes continuar con el indexado haciendo clic en "Añadir productos faltantes al índice".',
    'Add missing products to the index' => 'Añadir productos faltantes al índice',
    ...
    'Setting a weight to 0 will exclude that field from search index. Re-build of the entire index is required when changing to or from 0' => 'Establecer un peso excluirá ese campo del índice de búsqueda. Se recomienda reconstruir todo el índice cuando se cambia a 0 o a otro valor distinto a 0',
    ...
    'Round up away from zero, when it is half way there (recommended)' => 'Redondear al alza, cuando haya pasado la mitad (recomendado)',
    'Round down towards zero, when it is half way there' => 'Redondear a la baja, cuando haya pasado la mitad',
    'Round towards the next even value' => 'Redondear hasta el siguiente valor par',
    'Round towards the next odd value' => 'Redondear hasta el siguiente valor impar',
    ...
    'Hide this status in all customer orders.' => 'Ocultar este estatus en todos los pedidos de los clientes.',
    'Send an email to the customer when his/her order status has changed.' => 'Enviar un correo electrónico al cliente cuando el estatus de su pedido haya cambiado.',
  ...
  array (
    ...
    'How prices are displayed in the order summary for this customer group.' => 'Cómo los precios son visualizados en el resumen del pedido para los clientes de este grupo.',
    ...
    'With this option enabled, it also gives the good result if you search for “lous”, “ouse”, or anything contained in the word.' => 'Con esta opción habilitada, también se obtendrá el resultado correcto si buscas "Lusa", "usa", o cualquier otro carácter contenido en la palabra.',
    'Enable search within a whole word, rather than from its beginning only.' => 'Habilitar la búsqueda dentro de la palabra, no solo desde su inicio.',
    'It checks if the searched term is contained in the indexed word. This may be resource-consuming.' => 'Consulta si el término buscado está contenido en la palabra indexada. Esto puede consumir recursos.',
    ...
    'Please enter the index words separated by a "|".' => 'Por favor, introduce las palabras indexadas que están separadas por "|".',
    'Enter each alias separated by a comma (e.g. \'prestshop,preztashop,prestasohp\').' => 'Introduce los alias separados por comas (ej: "prestshop, preztashop,prestasohp").',
    'Forbidden characters: <>;=#{}' => 'Caracteres prohibidos: <>;=#{}',
    ...
    'You can\'t edit the shop group because the current shop belongs to a group with the "share" option enabled.' => 'No puedes editar este grupo de tiendas porque la tienda actual pertenece a un grupo que tiene la opción "compartir" habilitada.',
    ...
    'When enabled, all the pages of your shop will be SSL-secured.' => 'Cuando está habilitada, todas las páginas de tu tienda estarán protegidas por el protocolo de seguridad SSL.',
    ...
    'Clean the HTML content on text fields. We recommend that you leave this option enabled.' => 'Borrar el contenido HTML de los campos de texto. Recomendamos dejar esta opción habilitada.',
    'You can choose among 6 different ways of rounding prices. "Round up away from zero ..." is the recommended behavior.' => 'Puedes escoger entre 6 métodos diferentes de redondeo de precios. "Redondeo al alza..." es el más recomendado.',
    ...
    'Enable best sellers page on your front office even when its respective module is disabled.' => 'Habilitar la página de los productos más vendidos en el front office, incluso cuando su respectivo módulo esté deshabilitado.',
    ...
    'If you want to enable SSL on all the pages of your shop, activate the "Enable on all the pages" option below.' => 'Si quieres habilitar la certificación SSL en todas las páginas de tu tienda, activa la opción "Habilitar en todas las páginas".',
  ...
  array (
    ...
    'Aliases and results are both required.' => 'Los alias y sus resultados son requeridos.',
    ...
    'You need to select at least the root category.' => 'Necesitas seleccionar al menos la categoría raíz.',
    'Warning: You won\'t be able to change the group of this shop if this shop belongs to a group with one of these options activated: Share Customers, Share Quantities or Share Orders.' => 'Advertencia: No podrás cambiar el grupo de esta tienda si la misma pertenece a un grupo con alguna de las siguientes opciones activadas: Compartir clientes, Compartir cantidades o Compartir pedidos.',
    'You can only move your shop to a shop group with all "share" options disabled -- or to a shop group with no customers/orders.' => 'Sólo puedes mover tu tienda a un grupo de tiendas con todas las opciones de "compartir" deshabilitadas -- o a un grupo de tiendas sin clientes o pedidos.',
    'For security reasons, you cannot delete default order statuses.' => 'Por razones de seguridad, no puedes eliminar los estatus de los pedidos.',
    'An address located in a country containing states must have a state selected.' => 'Una dirección ubicada en un país que contiene estados debe tener un estado o provincia seleccionado(a).',
  ...
  array (
    ...
    'The specified date is invalid.' => 'La fecha especificada es inválida.',
  ),
  'EmailsBody' => 
  array (
    ...
    'Never disclose your login details to anyone.' => 'No comparta sus datos de inicio de sesión con otras personas.',
  ...
  array (
    ...
    'Newsletter voucher' => 'Cupón de descuento del Boletín de Noticias',
    'Newsletter confirmation' => 'Confirmación de la suscripción a nuestro Boletín de noticias',
    'Email verification' => 'Verificación del de correo electrónico',
  ...
  'Install' => 
  array (
    'Choose your language' => 'Selección su idioma',
    ...
    'An error occurred during logo upload.' => 'Ocurrió un error durante la carga del logo.',
    'Sports and Entertainment' => 'Deportes y Entretenimiento',
    'Invalid shop name' => 'Nombre de tienda inválido',
    ...
    'Create default shop and languages' => 'Crear tienda predeterminada e idiomas',
    ...
    'Help us learn more about your store so we can offer you optimal guidance and the best features for your business!' => 'Ayúdenos a aprender más acerca de su tienda, ¡para que le podamos ofrecer una orientación óptima y mejoras funcionales para su negocio!',
    ...
    'Last name' => 'Apellido',
    'E-mail address' => 'Dirección de correo electrónico',
    'This email address will be your username to access your store\'s back office.' => 'Este correo electrónico corresponderá a tu usuario en el acceso al interfaz de administración de tu tienda en línea.',
    ...
    'The default port is 3306. To use a different port, add the port number at the end of your server\'s address i.e ":4242".' => 'El puerto por defecto es el 3306. Si utiliza un puerto diferente, añada este número de puerto al final de la dirección del servidor con dos puntos, por ejemplo ":4242".',
    'Database name' => 'Nombre de la base de datos',
    'Database login' => 'Sistema de acceso de la base de datos',
    ...
    'Test your database connection now!' => '¡Comprobar la conexión a su base de datos ahora!',
    ...
    'PrestaShop requires at least 32 MB of memory to run: please check the memory_limit directive in your php.ini file or contact your host provider about this.' => 'Prestashop requiere al menos 32 MB de memoria para funcionar: Por favor chequea la directiva memory_limit en tu archivo php.ini o habla con tu proveedor de alojamiento acerca de esto.',
    ...
    'Cars' => 'Automóviles',
    'Computer Hardware and Software' => 'Hardware y Software Informático',
    'Download' => 'Descarga',
    ...
    '-- Please choose your main activity --' => '-- Por favor, selecciona tu actividad principal --',
    'Sport and Entertainment' => 'Deportes y Entretenimiento',
    ...
    'Database structure file not found' => 'Archivo de la estructura de la base de datos no encontrado',
  ...
  array (
    'Estimate the cost of shipping & taxes.' => 'Estime el costo de envío e impuestos.',
    'Country' => 'País',
    'State' => 'Estado ',
  ...
  array (
    ...
    'Adds a block featuring product categories.' => 'Añade un bloque con categorías de productos.',
    'Category root' => 'Categoría raíz',
  ...
  array (
    ...
    'An error occurred during the file-upload process.' => 'Ocurrió un error durante el proceso de subida del archivo.',
    ...
    'Your message has been successfully sent to our team.' => 'Su mensaje ha sido enviado exitosamente a nuestro equipo.',
  ...
  array (
    'Currency block' => 'Bloque de divisa',
    'Adds a block allowing customers to choose their preferred shopping currency.' => 'Añade un bloque que permite a los clientes elegir su moneda de compra preferida.',
  ),
  'ModulesCustomeraccountlinksAdmin' => 
  array (
    'My Account block' => 'Bloque Mi cuenta',
    'Displays a block with links relative to a user\'s account.' => 'Muestra un bloque con enlaces relativos a la cuenta de un usuario.',
    'Credit slips' => 'Recibos de abono',
  ...
  array (
    'Simple HTML table display' => 'Visualización sencilla de la tabla HTML',
  ...
  array (
    'New products block' => 'Bloque nuevos productos',
    'Displays a block featuring your store\'s newest products.' => 'Muestra un bloque con los productos más nuevos de su tienda.',
  ...
  array (
    'Viewed products block' => 'Bloque productos vistos',
  ...
  array (
    ...
    'Y-Align is required.' => 'Se necesita alineación Y.',
    'Y-Align is not in allowed range.' => 'Alineación Y no está en el rango permitido.',
    'X-Align is required.' => 'Se necesita alineación X.',
    'X-Align is not in allowed range.' => 'Alineación X está en el rango permitido.',
    'At least one image type is required.' => 'Se requiere al menos un tipo de imagen.',
    'An error occurred while uploading watermark: %1$s to %2$s' => 'Ocurrió un error al cargar marca de agua: %1$s en %2$s',
    ...
    'Choose image types for watermark protection:' => 'Elija el tipo de imagen para proteger con marca de agua:',
  ...
  array (
    ...
    'You must enter a voucher code.' => 'Debes introducir un código de cupón de descuento.',
    'The voucher code is invalid.' => 'El código del cupón de descuento no es válido.',
    ...
    'Sorry. We cannot renew your order.' => 'Lo sentimos. No podemos renovar tu pedido.',
    'Some items are no longer available, and we are unable to renew your order.' => 'Algunos artículos ya no están disponibles y por lo tanto no podemos renovar tu pedido.',
    'The order is no longer valid.' => 'Este pedido ya no es válido.',
    'This message is invalid (HTML is not allowed).' => 'Este mensaje es inválido (no se permite código HTML).',
  ...
  array (
    ...
    'You do not have any vouchers.' => 'No tiene ningún cupón de descuento.',
    'You cannot return merchandise with a guest account.' => 'No puede devolver mercancía con una cuenta de invitado.',
    'If you have just placed an order, it may take a few minutes for it to be validated. Please refresh this page if your order is missing.' => 'Si acabas de realizar un pedido, puede tomar unos minutos en ser validado. Por favor, actualiza la página si tu pedido no aparece.',
  ...
  array (
    ...
    'TE: Tax excluded' => 'IE: No incluye impuestos',
    'TI: Tax included' => 'II: Incluye impuestos',
    ...
    'Total (Tax excl.)' => 'Total (Imp. excl.)',
    'Total' => 'Total',
    'If the following conditions are not met, we reserve the right to refuse your package and/or refund:' => 'Si no se cumplen las siguientes condiciones, nos reservamos el derecho de rechazar tu paquete y/o reembolso:',
    'Please include this return reference on your return package:' => 'Por favor, incluye este número de referencia en la devolución del paquete:',
    ...
    'Please print out this document and slip it into your package.' => 'Por favor, imprime este documento e inclúyelo en el paquete.',
    'The package should be sent to the following address:' => 'El paquete debe ser enviado a la siguiente dirección:',
    'Upon receiving your package, we will notify you by e-mail. We will then begin processing the refund, if applicable. Let us know if you have any questions' => 'Al recibir el paquete, te notificaremos por correo electrónico. A continuación, se iniciaría el proceso de devolución, si corresponde. Si tienes alguna pregunta contáctanos',
    'Reference' => 'Referencia',
    'Qty' => 'Cant.',
    ...
    'Product Total (Tax Excl.)' => 'Total Producto (Impuestos Excl.)',
    'Product Total (Tax Incl.)' => 'Total Producto (Impuestos Incl.)',
  ...
  array (
    ...
    'PDF' => 'PDF',
    'Welcome to your account. Here you can manage all of your personal information and orders.' => 'Bienvenido a tu cuenta. Aquí puedes administrar todos tus pedidos y datos personales.',
    'Your account' => 'Su cuenta',
    ...
    'Guest Order Tracking' => 'Seguimiento de pedido de invitado',
    'To track your order, please enter the following information:' => 'Para rastrear tu pedido, por favor introduce la siguiente información:',
    'For example: QIIXJXNUI or QIIXJXNUI#1' => 'Ejemplo: QIIXJXNUI or QIIXJXNUI#1',
    'Guest Tracking' => 'Rastreo de pedido',
    'Transform your guest account into a customer account and enjoy:' => 'Convierte tu cuenta de invitado en una cuenta cliente y disfruta de:',
    'Personalized and secure access' => 'Acceso seguro y personalizado',
    'Fast and easy checkout' => 'Proceso de pago fácil y rápido',
    'Easier merchandise return' => 'Realizar devoluciones de manera fácil',
    'Order history' => 'Historial de pedidos',
    'Here are the orders you\'ve placed since your account was created.' => 'Estos son los pedidos que has realizado desde la creación de tu cuenta.',
    'Details' => 'Datos',
    'Your personal information' => 'Tu información personal',
    'Vouchers' => 'Cupones de descuento',
    'Credit slips' => 'Recibos de abono',
    ...
    'Add first address' => 'Añadir primera dirección',
    'Information' => 'Información',
    'Order history and details' => 'Historial de pedidos y sus detalles',
    'Merchandise returns' => 'Devoluciones de mercancía',
    'Order details' => 'Detalles del pedido',
    ...
    'Reminder' => 'Recordatorio',
    'All merchandise must be returned in its original packaging and in its original state.' => 'Toda la mercancía debe ser devuelta en su empaque original y también en buen estado.',
  ...
  array (
    ...
    'Date' => 'Fecha',
    'Status' => 'Estado',
    'We\'ll be back soon.' => 'Volveremos luego.',
