...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.43',
  'unifunc' => 'content_65a04ec0279d81_12787171',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '56b44170cef555c2cc96db1749000d46f766ac0f' => 
    array (
...
function content_65a04ec0279d81_12787171 (Smarty_Internal_Template $_smarty_tpl) {
	...
	<tr>
		<td class="center grey bold">
			<?php if ((isset($_smarty_tpl->tpl_vars['customfields_heading']->value)) && $_smarty_tpl->tpl_vars['customfields_heading']->value) {?>
				<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['customfields_heading']->value,'htmlall','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
...
?>
		<?php if ((isset($_smarty_tpl->tpl_vars['grouped_fields']->value[$_smarty_tpl->tpl_vars['key']->value])) && $_smarty_tpl->tpl_vars['grouped_fields']->value[$_smarty_tpl->tpl_vars['key']->value]) {?>
		 	<tr>
		 		<td colspan="2" class="header" valign="middle" style="border-top:1px solid #000;border-bottom:1px solid #000;text-align:center"><?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['title']->value,'htmlall','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
...
?>
				...
				<?php if ($_smarty_tpl->tpl_vars['field']->value['field_type'] == 'attachment') {?>
					<?php continue 1;?>
				<?php } else { ?>
					<tr class="product <?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['bgcolor_class']->value,'htmlall','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
">
						...
						<td class="left white" width="55%" style="margin-left:15px;">
							<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['field_value']->value,'htmlall','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
